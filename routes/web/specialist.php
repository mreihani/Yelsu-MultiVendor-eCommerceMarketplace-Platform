...
Route::group(['middleware' => ['visitorlogs']], function() {
    ...
    Route::get('copy/product/{id}', [SpecialistController::class, 'SpecialistCopyProduct'])->name('specialist.copy.product');
    Route::post('storeCopy/product', [SpecialistController::class, 'SpecialistStoreCopyProduct'])->name('specialist.storeCopy.product');
