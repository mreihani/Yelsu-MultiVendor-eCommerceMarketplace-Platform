...
class FreightageTypeAirService {
    ...
    private static function getClassObjectArray($freightage_array) {
        ...
        foreach ($freightage_array as $type_object) {
            $class_obj_arr[] = new FreightageTypeAirService($type_object['id'], $type_object['parent'], $type_object['value'], $type_object['description']);
        }
    ...
    public static function findById($id) {
        ...
        foreach ($freightage_loader_type_sea_array as $freightage_type_item) {
            if($freightage_type_item->id === (int) $id) {
              return new FreightageTypeAirService($freightage_type_item->id, $freightage_type_item->parent, $freightage_type_item->value, $freightage_type_item->description);
            }
        }
    }
