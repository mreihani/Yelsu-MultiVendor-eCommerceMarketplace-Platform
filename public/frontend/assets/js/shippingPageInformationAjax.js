...
function setDistanceHTMLVendor(distanceObject) {
    ...
    `
        ...
        &nbspفاصله بین مبدا و مقصد:&nbsp<strong class="shipping-distance-text">${distanceObject.text}</strong>
        </div>
    `;
