...
$(document).ready(function () {
    ...
    $(".ir-province[name='home_province']").prepend(
        `<option selected value="${homeProvinceDB} ">${homeProvinceDB} </option>`
    );
    $(".ir-city[name='home_city']").prepend(
        `<option selected value="${homeCityDB} ">${homeCityDB} </option>`
    );
