...
productInitialPriceValue = productInitialPriceValue ? productInitialPriceValue : 1;
...
$.extend($.easing, {
                ...
                Wolmart.call(Wolmart.ratingTooltip, 500),
                    ...
                    Wolmart.$body.on(
                        ...
                        function (e) {
                            ...
                            i.hasClass("disabled")
                                ? alert(
                                      "لطفاً قبل از افزودن این محصول به سبد خرید، چند گزینه محصول را انتخاب کنید."
                                  )
                                : (i
                                      .toggleClass("added")
                                      ...
                                      i.removeClass(
                                          ...
                                          Wolmart.Minipopup.open({
                                              ...
                                              imageLink: a
                                                  ...
                                                  .attr("href"),
                                              message:
                                                  "<p>به سبد خرید اضافه شده است.</p>",
                                              actionTemplate: `<a href='${homeURL}/cart' class="btn btn-rounded btn-sm">نمایش سبد </a><a href="${homeURL}/checkout" class="btn btn-dark btn-rounded btn-sm">پرداخت</a>`,
                                          });
                                  }, 500));
                        }
                    ),
                    ...
                    (function () {
                        ...
                        a.length ||
                            ...
                            (t(".page-wrapper").append(
                                '<div class="compare-popup">                    <div class="container">                        <div class="compare-title">                            <h4 class="title title-center">مقایسه مصولات</h4>                        </div>                        <ul class="compare-product-list list-style-none">                            <li></li><li></li><li></li><li></li>                        </ul>                        <a href="#" class="btn btn-clean">پاک کردن همه</a>                        <a href="compare.html" class="btn btn-dark btn-rounded">مقایسه را شروع کنید !</a>                    </div>                </div>                <div class="compare-popup-overlay">                </div>'
                            ),
                            (a = t(".page-wrapper > .compare-popup"))),
                            Wolmart.$body
                                .on(
    ...
    (function (t) {
        ...
        (e.min = 1),
            (e.max = 1e6),
            (e.value = productInitialPriceValue),
            ...
            (o.$wrapper = e),
                ...
                document.body.classList.contains("home") ||
                    (s.parent().hasClass("product-gallery-video") &&
                        ...
                        o.isQuickView ||
                            s.append(
                                '<a href="#" class="product-gallery-btn product-video-viewer" title="تصویر بندانگشتی ویدیوی محصول"><i class="w-icon-movie"></i></a>'
                            ))),
        ...
        function n(e) {
            ...
            if (i.hasClass("disabled"))
                ...
                if (a.length)
                    ...
                    var n =
                        `<div class="alert alert-success alert-cart-product mb-2">                            <a href="${homeURL}/cart" class="btn btn-success btn-rounded">نمایش سبد </a>                            <p class="mb-0 ls-normal">“` +
                        i
            ...
            (Wolmart.initLoginVendor = function (e) {
                ...
                i.find("#check-seller").on("click", function () {
                    i.find("#check-seller").addClass("active"),
                        ...
                        i.find("#check-merchant").removeClass("active"),
                        a.slideDown();
                }),
                    n.on("click", function () {
