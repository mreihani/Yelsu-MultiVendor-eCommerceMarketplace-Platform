...
<html direction="rtl" dir="rtl" style="direction: rtl" >
	...
	<body id="kt_body" class="app-blank app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			<!--begin::Page bg image-->
			<style>body { background-image: url({{asset('frontend/assets/plugins/global/bg7.jpg')}}); } [data-theme="dark"] body { background-image: url({{asset('frontend/assets/plugins/global/bg7-dark.jpg')}}); }</style>
			<!--end::Page bg image-->
				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							...
							<!--end::Title-->
							<!--begin::Text-->
							<div class="fw-semibold fs-6 text-gray-500 mb-7">مشکلی پیش آمد! لطفا بعداً دوباره امتحان کنید.</div>
							<!--end::Text-->
							<!--begin::Illustration-->
							<div class="mb-11">
								<img src="{{asset('frontend/assets/plugins/global/500-error.png')}}" class="mw-100 mh-300px theme-light-show" alt="" />
								<img src="{{asset('frontend/assets/plugins/global/500-error-dark.png')}}" class="mw-100 mh-300px theme-dark-show" alt="" />
							</div>
							<!--end::Illustration-->
							<!--begin::Link-->
							<div class="mb-0">
