                            ...
                            <div class="card-body pt-0">
                                <div class="table-responsive">
                                    ...
                                    <div class="card card-flush py-4">
                                        <!--begin::کارت body-->
                                        <div class="card-body pt-0">
                                            <form action="{{route('representative.order.changeStatus',$order->id)}}" method="POST">
                                            @csrf
                                            <!--begin::انتخاب2-->
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                                ...
                                                <tbody class="fw-semibold text-gray-600">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!--begin::Vendor Name-->
                                                        @php
                                                            $user = App\Models\User::find($product->representative_id);
                                                            if($user) {
                                                                $representative_info = $user->firstname .' '. $user->lastname;
                                                            } else {
                                                                $representative_info = "مدیریت";
                                                            }
                                                        @endphp 
                                                        <td class="text-end">{{$representative_info}}</td>
                                                        <!--end::Vendor Name-->
                                                        <!--begin::SKU-->
