    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card-body pt-9 pb-0">
                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                    ...
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="{{route('driver.profile')}}">پروفایل من </a>
                    </li>
                    <!--end::Nav item-->
                    <!--begin::Nav item-->
                    <li class="nav-item mt-2">
        ...
        <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
            ...
            <div class="card-header cursor-pointer">
                ...
                <!--end::کارت title-->
                <!--begin::Actions-->
                <a href="{{route('driver.profileSettings')}}" class="btn btn-sm btn-primary align-self-center">ویرایش اطلاعات</a>
                <!--end::Actions-->
            </div>
            <!--begin::کارت header-->
            <!--begin::کارت body-->
            <div class="card-body p-9">
                ...
                <div class="row mb-7">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-800">{{$driverData->firstname . " " . $driverData->lastname}}</span>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Row-->
                ...
                <div class="row mb-7">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        <a href="#" class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{$driverData->username}}</a>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-8 fv-row">
                        <span class="fw-semibold text-gray-800 fs-6">{{$driverData->email}}</span>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-8 d-flex align-items-center">
                        @if($driverData->home_phone && $driverData->phone_verified)
                            <span class="fw-bold fs-6 text-gray-800 me-2">{{$driverData->home_phone}}</span><span class="badge badge-success">تایید شده</span>
                        @else
                ...
                <div class="row mb-7">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-800">{{$driverData->shop_address}}</span>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-7">
                    <!--begin::Tags-->
                    <label class="col-lg-4 fw-semibold text-muted">زمینه فعالیت راننده
                    <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="زمینه فعالیت راننده از طریق تنظیمات حساب کاربری تعیین می شود"></i></label>
                    
                    <!--end::Tags-->
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        @if($driverData->driver->type)
                            ...
                            @if($driverData->driver->status == "inactive")
                                <div class="badge badge-light-warning fw-bold">
                                    آخرین اطلاعات ثبت شده در دست بررسی و هنوز تأیید نشده است
                                </div>
                            @endif
                        @else    
                            <span>لطفا از بخش <a href="{{route('driver.profileSettings')}}">تنظیمات حساب کاربری</a> زمینه فعالیت راننده را تعیین نمایید</span>
                        @endif
                    </div>
                    <!--end::Col-->
                </div>
