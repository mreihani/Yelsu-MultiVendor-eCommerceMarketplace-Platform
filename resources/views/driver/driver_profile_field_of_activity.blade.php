            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    <div class="card-body pt-9 pb-0">
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            ...
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="{{route('driver.profileFieldOfActivity')}}">زمینه فعالیت</a>
                            </li>
                            <!--end::Nav item-->
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show profileFieldOfActivityFreightagePage">
                        <!--begin::Form-->
                        <form id="kt_account_profile_details_form" class="form" method="POST" action={{route('driver.profileFieldOfActivity.store')}} enctype="multipart/form-data">
                            @csrf
                            <!--begin::کارت body-->
                            <div class="card-body border-top p-9">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        ...
                                        <div class="form-group mb-5">
                                            ...
                                            <div class="subCategoryBtn">
                                                ...
                                                {{-- <li class="filterButtonShopPage list-style-none " style="margin-right: 35px;">
                                                    <input type="checkbox" name="type[]" value="6" {{in_array(6, $driver_sector_arr) ? 'checked' : ''}}> ریلی
                                                </li> --}}

                                            </div>   

                                            {{-- <li class="filterButtonShopPage rootCat list-style-none">
                                                <input type="checkbox" name="type[]" value="7" {{in_array(7, $driver_sector_arr) ? 'checked' : ''}}> هوایی 
                                            </li> --}}

                                            {{-- <li class="filterButtonShopPage rootCat list-style-none">
                                                <input type="checkbox" name="type[]" value="8" {{in_array(8, $driver_sector_arr) ? 'checked' : ''}}> آبی 
                                            </li> --}}
                                        </div>
                                    </div>
                                    <!--end::Col-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <div class="form-group mb-5">
                                            <label class="form-label text-info">هر راننده فقط می تواند یک نوع خودرو را انتخاب نماید.</label>
                                            <li class="filterButtonShopPage rootCat list-style-none"> 
                                ...
                                @if (count($vendor_sector_cat_arr))
                                    <div class="row mb-6">
                                        ...
                                        <label class="col-lg-4 col-form-label fw-semibold fs-6 required">
                                            ...
                                            <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="لطفا دسته بندی مرتبط با شرکت راننده را از گزینه های روبه انتخاب نمایید."></i></label>
                                        </label>
                                        <!--end::Tags-->
