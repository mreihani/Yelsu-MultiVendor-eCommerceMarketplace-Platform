                    ...
                    <div class="sidebar-content">
                        <div class="sticky-sidebar">
                            <div class="widget widget-collapsible widget-categories">
                                <h3 class="widget-title"><span>زمینه فعالیت راننده</span></h3>
                            ...
                            {{-- <div class="widget widget-collapsible widget-contact">
                                <h3 class="widget-title"><span>تماس با  راننده </span></h3>
                ...
                <div class="main-content">
                    <div class="store store-banner mb-4">
                        <figure class="store-media">
                            <img src="{{(!empty($driver->store_banner)) ? url('storage/upload/driver_images/'.$driver->store_banner) : url('storage/upload/driver_banner.jpg')}}" alt="Vendor" width="930" height="446"
                                style="background-color: #414960;" />
                        </figure>
                        <div class="store-content">
                            <figure class="seller-brand">
                                <img src="{{!empty($driver->photo) ? url('storage/upload/driver_images/'.$driver->photo) : url('storage/upload/driver_logo.png')}}" alt="Brand" width="80"
                                    height="80" />
                            </figure>
                            <h4 class="store-title">{{$driver->shop_name}}</h4>
