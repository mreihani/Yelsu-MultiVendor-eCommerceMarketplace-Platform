            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    <div class="card-body pt-9 pb-0">
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            ...
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="{{route('merchant.profileFinancialStatement')}}">صورتحساب</a>
                            </li>
                            <!--end::Nav item-->
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form id="kt_account_profile_details_form" class="form" method="POST" action={{route('merchant.profileFinancialStatement.store')}} enctype="multipart/form-data">
                            @csrf
                            <!--begin::کارت body-->
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row d-flex">
                                        <input id="shaba_number_input" type="text" name="shaba_number" class="form-control form-control-lg form-control-solid" placeholder="به عنوان نمونه: 250190000000101416297007" value="{{old('shaba_number') ? old('shaba_number') : $merchantData->shaba_number}}" /><span id="shaba_number">IR</span>
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input id="cart_number" type="text" name="cart_number" class="form-control form-control-lg form-control-solid" placeholder="به عنوان نمونه: 6104337770039251" value="{{old('cart_number') ? old('cart_number') : $merchantData->cart_number}}" />
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                <!--end::Input group-->
                                ...
                                <!--begin::Input group-->
                                 <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="cart_owner_info" class="form-control form-control-lg form-control-solid" placeholder="به عنوان نمونه: علی کیهانی" value="{{old('cart_owner_info') ? old('cart_owner_info') : $merchantData->cart_owner_info}}" />
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="cart_bank_info" class="form-control form-control-lg form-control-solid" placeholder="به عنوان نمونه: صادرات" value="{{old('cart_bank_info') ? old('cart_bank_info') : $merchantData->cart_bank_info}}" />
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                <!--end::Input group-->
