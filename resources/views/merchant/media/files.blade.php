                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Add customer-->
                            <a href="{{route('merchant.media.add')}}" class="btn btn-primary">افزودن تصویر</a>
                            <!--end::Add customer-->
                        </div>
                        <!--end::کارت toolbar-->
                    </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center">کپی آدرس</th>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                @foreach ($files as $file)
                                    ...
                                    @if($file->user_id === $merchantData->id)
                                    <tr>
                                        <!--begin::Checkbox-->
                                        <td>
                                        ...
                                        <td>
                                            <!--begin::Badges-->
                                                <button class='copyBtn btn btn-sm btn-primary' type="button">
                                                    کپی
                                                </button>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{route('merchant.media.delete', $file->id)}}" class="menu-link px-3" onclick ="return confirm('آیا برای انجام این کار اطمینان دارید؟')">حذف</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </div>
                                            <!--end::Menu-->
