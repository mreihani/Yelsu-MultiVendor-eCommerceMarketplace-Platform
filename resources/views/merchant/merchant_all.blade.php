        ...
        <div class="container">
            ...
            {{-- <div class="toolbox vendor-toolbox pb-0">
                <div class="toolbox-left mb-4 mb-md-0">
                    ...
                    <label class="d-block vendor-total-num">تعداد فروشندگان {{count($merchants)}}</label>
                </div>
            ...
            <div class="container mt-10">
                <div class="shop-default-category">                           
                    <h4 class="text-center">مکان یابی بازرگانان</h4>
                    <div id="map"></div>
                </div>
            </div>
            @elseif(!count($merchants))
            <div class="container mt-10">
                <div class="shop-default-category">                           
                    ...
                    <div class="store store-grid">
                        <div class="store-header">
                            <figure class="store-banner">
                                <img src="{{(!empty($merchant->store_banner)) ? url('storage/upload/merchant_images/'.$merchant->store_banner) : url('storage/upload/no_image_store.jpg')}}" alt="merchant" 
                        ...
                        {{-- @php
                            $merchant_sector_arr = explode(",", $merchant->merchant_sector);
                            $merchant_sector_cat_arr = [];
                            foreach ($merchant_sector_arr as $merchant_sector_item) {
                                $merchant_sector_cat_arr[] = App\Models\Category::find($merchant_sector_item);
                            }
                        @endphp --}}

                        <div class="store-content">
                            <h4 class="store-title">
                                <a href="{{route('merchant.details',$merchant->id)}}">{{$merchant->shop_name}}</a>
                            </h4>
                        ...
                        <div class="store-footer">
                            <figure class="seller-brand">
                                <img src="{{(!empty($merchant->photo)) ? url('storage/upload/merchant_images/'.$merchant->photo) : url('storage/upload/no_image.jpg')}}" alt="Brand" width="80" height="80" />
                            </figure>
                            <a href="{{route('merchant.details',$merchant->id)}}" class="btn btn-dark btn-link btn-underline btn-icon-right btn-visit">
