            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="card-body pt-9 pb-0">
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="{{route('merchant.profile')}}">پروفایل من </a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="{{route('merchant.profileSettings')}}">تنظیمات</a>
                            </li>
                            <!--end::Nav item-->
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form id="kt_account_profile_details_form" class="form" method="POST" action={{route('merchant.profile.store')}} enctype="multipart/form-data">
                            @csrf
                            <!--begin::کارت body-->
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
                                            ...
                                            <div id="ShowImage" class="image-input-wrapper w-125px h-125px" style="background-image: url({{!empty($merchantData->photo) ? url('storage/upload/merchant_images/' . $merchantData->photo) : url('storage/upload/no_image.jpg') }})"></div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
                                            <!--begin::نمایش existing avatar-->
                                            <div id="ShowImage" class="image-input-wrapper w-400px h-194px storeBanner" style="background-image: url({{!empty($merchantData->store_banner) ? url('storage/upload/merchant_images/' . $merchantData->store_banner) : url('storage/upload/no_image_store.jpg') }})"></div>
                                            <!--end::نمایش existing avatar-->
                                            <!--begin::Tags-->
                                ...
                                <!--begin::Input group-->
                                 <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <select id="person" name="person_type" class="form-control form-control-lg form-control-solid form-select">
                                            <option {{$merchantData->person_type == "haghighi" ? "selected" : ""}} value="haghighi">شخص حقیقی</option>
                                            <option {{$merchantData->person_type == "hoghoghi" ? "selected" : ""}} value="hoghoghi">شخص حقوقی</option>
                                        </select>
                                    </div>
                                 </div>
                                <!--end::Input group-->
                                ...
                                {{-- <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input disabled type="text" class="form-control form-control-lg form-control-solid" placeholder="نام کاربری" value="{{$merchantData->username}}" />
                                    </div>
                                    <!--end::Col-->
                                </div> --}}
                                 ...
                                 <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="shop_name" class="form-control form-control-lg form-control-solid" placeholder="نام فروشگاه یا شرکت" value="{{$merchantData->shop_name}}" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="shop_address" class="form-control form-control-lg form-control-solid" placeholder="آدرس فروشگاه / شرکت" value="{{$merchantData->shop_address}}" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 fv-row">
                                                <input type="text" name="firstname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="نام" value="{{$merchantData->firstname}}" />
                                            </div>
                                            <!--end::Col-->
                                            <!--begin::Col-->
                                ...
                                <div class="row mb-6 haghighi">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            <!--begin::Col-->
                                            <div class="col-lg-12 fv-row">
                                                <input type="text" name="lastname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="نام خانوادگی" value="{{$merchantData->lastname}}" />
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Row-->
                                ...
                                <div class="row mb-6 haghighi">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="national_code" class="form-control form-control-lg form-control-solid" placeholder="کد ملی" value="{{$merchantData->national_code}}" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6 hoghoghi">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="company_number" class="form-control form-control-lg form-control-solid" placeholder="شماره شناسه شرکت" value="{{$merchantData->company_number}}" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6 hoghoghi">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="agent_name" class="form-control form-control-lg form-control-solid" placeholder="نام نماینده" value="{{$merchantData->agent_name}}" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    <!--begin::Tags-->
                                    <label class="col-lg-4 col-form-label fw-semibold fs-6 required">زمینه فعالیت بازرگان</label>
                                    <!--end::Tags-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <select class="form-select mb-2" data-control="select2" name="merchant_type" data-hide-search="true" data-placeholder="انتخاب" id="kt_ecommerce_add_product_currency_select">
                                            <option value="none" {{$merchantData->merchantUser->merchant_type == 'none' ? "selected" : ""}}>لطفا زمینه فعالیت بازرگان را انتخاب نمایید</option>
                                            <option value="import" {{$merchantData->merchantUser->merchant_type == 'import' ? "selected" : ""}}>واردات</option>
                                            <option value="export" {{$merchantData->merchantUser->merchant_type == 'export' ? "selected" : ""}}>صادرات</option>    
                                            <option value="both" {{$merchantData->merchantUser->merchant_type == 'both' ? "selected" : ""}}>واردات و صادرات</option>    
                                        </select>
                                    </div>
                                    <!--end::Col-->
                                </div>
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <a href="{{route('merchant.profile')}}" type="button" class="btn btn-light btn-active-light-primary me-2">لغو</a>
                ...
                {{-- <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_signin_password_edit" class="flex-row-fluid m-10">
                        ...
                        <form  class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="{{route('merchant.update.password')}}">
                            @csrf
                            <div class="row mb-1">
                                <div class="col-lg-4">
...
<script>
    let person_type = {!! json_encode($merchantData->person_type) !!};
