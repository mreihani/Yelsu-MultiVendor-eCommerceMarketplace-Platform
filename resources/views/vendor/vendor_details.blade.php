                ...
                <div class="main-content">
                    <div class="store store-banner mb-4">
                        <figure class="store-media">
                            <img src="{{(!empty($vendor->store_banner)) ? url('storage/upload/vendor_images/'.$vendor->store_banner) : url('storage/upload/no_image_store.jpg')}}" alt="Vendor" width="930" height="446"
                                style="background-color: #414960;" />
                        </figure>
                        <div class="store-content">
                            <figure class="seller-brand">
                                <img src="{{(!empty($vendor->photo)) ? url('storage/upload/vendor_images/'.$vendor->photo) : url('storage/upload/no_image.jpg')}}" alt="Brand" width="80"
                                    height="80" />
                            </figure>
                    ...
                    @if($vendor->vendor_description && $vendor->vendor_description_status == 'active')
