<div class="d-flex flex-wrap flex-sm-nowrap mb-3">
    ...
    <div class="me-7 mb-4">
        <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
            <img src="{{!empty($vendorData->photo) ? url('storage/upload/vendor_images/' . $vendorData->photo) : url('storage/upload/no_image.jpg') }}" alt="image" />
        ...
        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center mb-2">
                    <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{$vendorData->firstname . " " . $vendorData->lastname}}</a>
                    <a href="#">
                ...
                <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                    ...
                    <!--end::Svg Icon-->{{$vendorData->email}}</a>
                </div>
                <!--end::Info-->
            </div>
            <!--end::user-->
