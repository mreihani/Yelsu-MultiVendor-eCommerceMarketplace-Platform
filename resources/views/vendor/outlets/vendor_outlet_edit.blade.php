        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">ویرایش آدرس انبار / کارگاه / کارخانه / دپوی کالا</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show outlet-page">
                        <!--begin::Form-->
                        <form id="kt_account_profile_details_form" class="form" method="POST" action={{route('vendor.update.outlet')}} enctype="multipart/form-data">
                            @csrf
                            <!--begin::کارت body-->
                            <div class="card-body border-top p-9">
                                ...
                                <!--begin::Input group-->
                                 <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="shop_name" class="form-control form-control-lg form-control-solid" placeholder="نام محل مورد نظر خود را وارد نمایید" value="{{old('shop_name') ? old('shop_name') : $outlet->shop_name }}"/>
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="shop_address" id="shop_address" class="form-control form-control-lg form-control-solid" placeholder="آدرس محل مورد نظر را وارد نمایید" value="{{old('shop_address') ? old('shop_address') : $outlet->shop_address }}" />
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="number" name="shop_postalcode" class="form-control form-control-lg form-control-solid" placeholder="کد پستی محل مورد نظر را وارد نمایید" value="{{old('shop_postalcode') ? old('shop_postalcode') : $outlet->shop_postalcode }}" />
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="number" name="shop_phone" class="form-control form-control-lg form-control-solid" placeholder="شماره تلفن محل مورد نظر را وارد نمایید" value="{{old('shop_phone') ? old('shop_phone') : $outlet->shop_phone }}" />
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="number" name="shop_fax" class="form-control form-control-lg form-control-solid" placeholder="شماره فکس محل مورد نظر را وارد نمایید" value="{{old('shop_fax') ? old('shop_fax') : $outlet->shop_fax }}" />
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                <!--end::Input group-->
                                                ...
                                                @foreach ($filter_category_array as $category)
                                                    ...
                                                    <div class="subCategoryBtn">
                                                        @foreach ($category[1] as $sub_cat_item)
                                                            @if (in_array($sub_cat_item->id, $vendor_sector_cat_arr_selected))
                                                ...
                                                @foreach ($filter_category_array as $category)
                                                    <li class="filterButtonShopPage rootCat">
                                                        @if(in_array($category[0]->id, $vendor_sector_cat_arr_selected))
                                                            <input @checked(true) type="checkbox" name="category_id[]" value="{{$category[0]->id}}"> <i class="fa fa-plus" style="display: none;"></i><i class="fa fa-minus"></i> {{$category[0]->category_name}} {{count($category[1]) ? "(".count($category[1])." زیر دسته)" : ''}}
                                                        @else
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <a type="reset" class="btn btn-light btn-active-light-primary me-2" href="{{route('vendor.all.outlet')}}">لغو</a>
