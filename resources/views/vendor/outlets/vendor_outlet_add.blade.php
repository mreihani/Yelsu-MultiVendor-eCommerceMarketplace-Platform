            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show outlet-page">
                        <!--begin::Form-->
                        <form id="kt_account_profile_details_form" class="form" method="POST" action={{route('vendor.store.outlet')}} enctype="multipart/form-data">
                            @csrf
                            <!--begin::کارت body-->
                                            ...
                                            <ul class="list-style-none">
                                                @foreach ($filter_category_array as $category)
                                                    <li class="filterButtonShopPage rootCat">
                                                        <input type="checkbox" name="category_id[]" value="{{$category[0]->id}}"> <i class="fa fa-plus" style="display: none;"></i><i class="fa fa-minus"></i> {{$category[0]->category_name}} {{count($category[1]) ? "(".count($category[1])." زیر دسته)" : ''}}
                                                    </li>
                                                    <div class="subCategoryBtn">
                                                        @include('vendor.outlets.layouts.categories-group', ['categories' => $category[1]])
                                                    </div>
                                                @endforeach
                                            </ul>      
                                        </div>
