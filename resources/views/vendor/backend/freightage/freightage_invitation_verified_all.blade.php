                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        {{-- <div class="card-toolbar">
                            <!--begin::Add customer-->
                            <a href="" class="btn btn-primary">افزودن </a>
                            <!--end::Add customer-->
                        </div> --}}
                        <!--end::کارت toolbar-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center">زمینه فعالیت</th>
                                    <th class="text-center min-w-100px">دسته بندی مرتبط</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                <a href="">
                                                    <div class="symbol-label">
                                                        <div class="symbol-label fs-3 bg-light-info text-info">{{mb_substr($invitation->freightage->shop_name, 0, 1, "UTF-8")}}</div>
                                                    </div>
                                                </a>
                                            </div>
                                            <!--end::Avatar-->
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="" class="text-gray-800 text-hover-primary mb-1">{{$invitation->freightage->shop_name}}</a>
                                                <span>{{$invitation->freightage->email}}</span>
                                            </div>
                                            <!--begin::کاربر details-->
                                        </td>
                                        <!--end::کاربر=-->
                                        ...
                                        <td>
                                            <!--begin::Badges-->
                                            @foreach (App\Services\Categories\GetCategoryByStringIds\GetCategoryByStringIds::getCategoryByIds($invitation->freightage->freightage->category_id) as $category_item)
                                                <div class="badge badge-light-primary">
                                        ...
                                        <!--begin::عملیات=-->
                                        <td class="text-end">
                                            <a href="{{route('vendor.edit.freightage', $invitation->id)}}" class="btn btn-sm btn-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">نمایش جزئیات
                                            ...
                                            {{-- <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="" class="menu-link px-3">ویرایش</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
