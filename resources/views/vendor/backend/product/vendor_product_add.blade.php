    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::آیتم-->
                        <!--begin::آیتم-->
                        <li class="breadcrumb-item text-muted">افزودن محصول</li>
                        <!--end::آیتم-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <!--begin::Form-->
                <form class="form d-flex flex-column flex-lg-row" method="POST" action="{{route('vendor.store.product')}}" enctype="multipart/form-data">
                    @csrf
                                ...
                                <ul class="list-style-none mt-4">
                                    @foreach ($filter_category_array as $category)
                                        ...
                                        <div class="subCategoryBtn">
                                            @include('vendor.body.layouts.vendor_product.categories-group', ['categories' => $category[1]])
                                        </div>
                                    @endforeach
                                </ul>   
                            </div>
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::Input-->
                                                <input type="text" name="product_name" class="form-control mb-2" placeholder="نام محصول" value="{{old('product_name')}}"/>
                                                <!--end::Input-->
                                                <!--begin::توضیحات-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--begin::توضیحات-->
                                                <div class="text-muted fs-7">
                                                    اسلاگ یا URL مورد نیاز است و توصیه می شود منحصر به فرد و انگلیسی باشد.
                                                </div>
                                                <br>
                                                <div class="text-muted fs-7">
                                            ...
                                            <!--begin::Input group-->
                                             <div class="mt-10">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::or-->
                                                    <textarea name="long_desc" id="long_desc">{{old('long_desc')}}</textarea>
                                                <!--end::or-->
                                                <!--begin::توضیحات-->
                                                <div class="text-muted fs-7">برای دید بهتر، توضیحاتی را برای محصول تنظیم کنید.</div>
                                                <!--end::توضیحات-->
                                            ...
                                            <!--end::Input group-->
                                             ...
                                             <div class="mt-10">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::or-->
                                                    <textarea name="specification" id="specification">{{old('specification')}}</textarea>
                                                <!--end::or-->
                                                <!--begin::توضیحات-->
                                        ...
                                        <div class="card-body pt-0 ">
                                            ...
                                            <div class="fv-row">
                                                ...
                                                <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                                    ...
                                                    <input class="form-check-input w-45px h-30px mr-3 ml-3" type="checkbox" id="userHasVehicle" name="user_has_vehicle">
                                                </div>
                                                <!--end::Tags-->
                                                <!--begin::توضیحات-->
                                    ...
                                    @if(count($vendorData->vendor_outlets))
                                        <div class="card card-flush py-4" id="product-outlet-body">
                                            ...
                                            <div class="card-body pt-0">
                                                <!--begin::Input group-->
                                                <div class="fv-row">
                                                    @foreach($vendorData->vendor_outlets as $outlet_item_key => $outlet_item)
                                                ...
                                                <div class="d-flex align-items-center justify-content-between border border-dashed border-gray-300 rounded px-7 py-3 mt-10">
                                                    ...
                                                    <div class="fs-5 text-dark text-hover-primary fw-semibold w-375px ">
                                                        ...
                                                        <span id="commission-type-title">
                                                            میزان کمیسیون دریافتی از خریدار
                                                        </span>
                                                    </div>
                                                    <!--end::Title-->
                                                    ...
                                                    <!--begin::پردازش-->
                                                    <div class="pe-2">
                                                        <span id="commission_value" class="badge badge-light-danger">
                                                            ناموجود
                                                        </span>
                                                    </div>
                                                    <!--end::پردازش-->
                            ...
                            <div class="tab-pane fade" id="kt_ecommerce_add_product_advanced" role="tab-panel">
                                <div class="d-flex flex-column gap-7 gap-lg-10">
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::Input-->
                                                <input type="text" name="product_code" class="form-control mb-2" placeholder="کد محصول را وارد کنید" value="" />
                                                <!--end::Input-->
                                                <!--begin::توضیحات-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <div class="d-flex gap-3">
                                                    <input type="number" name="product_qty" class="form-control mb-2" placeholder="موجودی انبار" value="" />
                                                </div>
                                                <!--end::Input-->
                                                <!--begin::توضیحات-->
                                            ...
                                            <div class="fv-row">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid mb-2">
                                                    <input class="form-check-input" type="checkbox" name="unlimitedStock" value="active" checked/>
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-header">
                                            <div class="card-title">
                                                <h2>چگونه در جستجوی گوگل بهتر دیده شویم؟</h2>
                                            </div>
                                        </div>
                                        <!--end::کارت header-->
                                        <!--begin::کارت body-->
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <!--end::Input-->
                                                <!--begin::توضیحات-->
                                                <div class="text-muted fs-7">برای اینکه در جستجوی گوگل بتوانیم به عنوان اولین گزینه ها باشیم توصیه ما این است که از کلمات کلیدی ساده و دقیق استفاده کنید.</div>
                                                <!--end::توضیحات-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="mb-10">
                                                ...
                                                <!--end::or-->
                                                <!--begin::توضیحات-->
                                                <div class="text-muted fs-7">برای افزایش رتبه سئو در گوگل، در قسمت توضیحات متا تگ متن کوتاهی را برای این محصول بنویسید.</div>
                                                <!--end::توضیحات-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
