                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            ...
                            {{-- <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <!--end::Svg Icon-->
                                <input type="text" data-kt-ecommerce-category-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="جستجو فروشگاه / شرکت" />
                            </div> --}}
                            <!--end::جستجو-->
                        </div>
                        <!--end::کارت title-->
                        ...
                        <div class="card-toolbar">
                            <!--begin::Add customer-->
                            <a href="{{route('retailer.create.outlet')}}" class="btn btn-primary">افزودن آدرس</a>
                            <!--end::Add customer-->
                        </div>
                        <!--end::کارت toolbar-->
                    </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="">ردیف</th>
                                    <th class="min-w-150px">نام فروشگاه / شرکت</th>
                                    <th class="">آدرس</th>
                                    <th class="">کد پستی</th>
                                    <th class="">تلفن</th>
                                    <th class="">فکس</th>
                                ...
                                @if($outlets)
                                    ...
                                    @foreach ($outlets as $key => $outlet)
                                        <tr>
                                            ...
                                            <td>
                                                <!--begin::Badges-->
                                                <div class="">{{$outlet->shop_name}}</div>
                                                <!--end::Badges-->
                                            </td>
                                            
                                            <td>
                                                <!--begin::Badges-->
                                                <div class="">{{$outlet->shop_address}}</div>
                                                <!--end::Badges-->
                                            </td>

                                            <td>
                                                <!--begin::Badges-->
                                                @if($outlet->shop_postalcode)
                                                    <div class="">{{$outlet->shop_postalcode}}</div>
                                                @else
                                            ...
                                            <td>
                                                <!--begin::Badges-->
                                                @if($outlet->shop_phone)
                                                    <div class="">{{$outlet->shop_phone}}</div>
                                                @else
                                                    <div class="badge badge-light">ناموجود</div>
                                                @endif
                                                <!--end::Badges-->
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('retailer.edit.outlet', $outlet->id)}}" class="menu-link px-3">ویرایش</a>
                                                    </div>
                                                    <!--end::Menu item-->

                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('retailer.delete.outlet', $outlet->id)}}" class="menu-link px-3" onclick ="return confirm('آیا برای انجام این کار اطمینان دارید؟')">حذف</a>
                                                    </div>
                                                    <!--end::Menu item-->
