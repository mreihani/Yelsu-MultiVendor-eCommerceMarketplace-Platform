<div class="d-flex flex-wrap flex-sm-nowrap mb-3">
    ...
    <div class="me-7 mb-4">
        <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
            <img src="{{!empty($retailerData->photo) ? url('storage/upload/retailer_images/' . $retailerData->photo) : url('storage/upload/no_image.jpg') }}" alt="image" />
        ...
        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center mb-2">
                    <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{$retailerData->firstname . " " . $retailerData->lastname}}</a>
                    <a href="#">
                ...
                <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                    ...
                    <!--end::Svg Icon-->{{$retailerData->email}}</a>
                </div>
                <!--end::Info-->
            </div>
            <!--end::user-->
                ...
                <div class="me-0">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3 my-1">
                            <a href="{{route('retailer.profileSettings')}}" class="menu-link px-3">تنظیمات</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
                    <!--end::Menu 3-->
