                    ...
                    <div class="sidebar-content">
                        <div class="sticky-sidebar">
                            <div class="widget widget-collapsible widget-categories">
                                <h3 class="widget-title"><span>زمینه فعالیت فروشنده</span></h3>
                            ...
                            {{-- <div class="widget widget-collapsible widget-contact">
                                <h3 class="widget-title"><span>تماس با فروشنده </span></h3>
                ...
                <div class="main-content">
                    <div class="store store-banner mb-4">
                        <figure class="store-media">
                            <img src="{{(!empty($retailer->store_banner)) ? url('storage/upload/retailer_images/'.$retailer->store_banner) : url('storage/upload/no_image_store.jpg')}}" alt="Vendor" width="930" height="446"
                                style="background-color: #414960;" />
                        </figure>
                        <div class="store-content">
                            <figure class="seller-brand">
                                <img src="{{(!empty($retailer->photo)) ? url('storage/upload/retailer_images/'.$retailer->photo) : url('storage/upload/no_image.jpg')}}" alt="Brand" width="80"
                                    height="80" />
                            </figure>
                            <h4 class="store-title">{{$retailer->shop_name}}</h4>
                            {{-- <ul class="seller-info-list list-style-none mb-6">
                                ...
                                <li class="store-phone">
                                    <a href="tel:{{$retailer->home_phone}}">
