                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <form action="{{route('retailer.orders.view', $order->id)}}" method="GET" id="viewOrder">
                                                        @csrf
                                                    </form>
                                                    <a onclick="document.getElementById('viewOrder').submit();" href="{{route('retailer.orders.view', $order->id)}}" class="menu-link px-3">جزئیات سفارش</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <form action="{{route('retailer.orders.destroy', $order->id)}}" method="POST" id="deleteOrder-{{$order->id}}">
                                                        @csrf
                                                    </form>
