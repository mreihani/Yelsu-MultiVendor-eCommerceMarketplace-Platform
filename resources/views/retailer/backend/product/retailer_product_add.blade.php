    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <!--begin::Form-->
                <form class="form d-flex flex-column flex-lg-row" method="POST" action="{{route('retailer.store.product')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                           ...
                           <input type="hidden" value="retailer" id="user-role">
                           ...
                           <input type="hidden" value="retailer" id="product-user-role">
                                ...
                                <ul class="list-style-none mt-4">
                                    @foreach ($filter_category_array as $category)
                                        ...
                                        <div class="subCategoryBtn">
                                            @include('retailer.body.layouts.retailer_product.categories-group', ['categories' => $category[1]])
                                        </div>
                                    @endforeach
                                </ul>   
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::Input-->
                                                <input type="text" name="selling_price" class="form-control mb-2" placeholder="قیمت محصول" value="{{old('selling_price')}}" />
                                                <!--end::Input-->
                                                <!--begin::توضیحات-->
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{route('retailer.all.product')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">انصراف</a>
                            <!--end::Button-->
                            <!--begin::Button-->
