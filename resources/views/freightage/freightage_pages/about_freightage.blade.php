        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">اطلاعات باربری</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form id="kt_account_profile_details_form" class="form" method="POST" action="{{route('freightage.about.store')}}">
                            @csrf
                            <!--begin::کارت body-->
                            <div class="card-body border-top p-9">
                                <h5 class="mb-10">
                                    لطفا شرحی از شرکت باربری را وارد نمایید.
                                </h5>
                                ...
                                <div class="mt-10">
                                    ...
                                    <div class="text-muted fs-7">
                                        این اطلاعات پس از تایید کارشناس در صفحه شرکت باربری نمایش داده خواهد شد.
                                    </div>
                                    <!--end::توضیحات-->
                                </div>
                                <!--end::Input group-->
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <a type="reset" class="btn btn-light btn-active-light-primary me-2" href="{{route('freightage.dashboard')}}">لغو</a>
