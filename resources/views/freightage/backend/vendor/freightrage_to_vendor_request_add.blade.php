                    ...
                    <div class="pt-0">
                        <div class="card mb-5 mb-xl-10">
                            ...
                            <div id="kt_account_settings_profile_details" class="collapse show profileFieldOfActivityFreightagePage">
                                <!--begin::Form-->
                                <form id="kt_account_profile_details_form" class="form" method="POST" action={{route('freightage.store.vendor-request')}} enctype="multipart/form-data">
                                    @csrf
                                    <!--begin::کارت body-->
                                    ...
                                    <div class="card-footer d-flex justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-primary" id="kt_account_profile_details_submit">ارسال درخواست</button>
                                    </div>
                                    <!--end::Actions-->
                                </form>
                                <!--end::Form-->
