@foreach ($items as $item)
    ...
    @if(in_array($item->id, $loader_type_sea_arr_selected))
    ...
    @if(count($item->getChildren)) 
        ...
        <div class="mb-1 subCatGroup" style="margin-right: 30px;">
            @include('freightage.layouts.field_of_activity.field-of-activity-loader-type-sea-group', ['items' => $item->getChildren])  
        </div>
