            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    <div class="card-body pt-9 pb-0">
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            ...
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="{{route('freightage.profileSettings')}}">تنظیمات</a>
                            </li>
                            <!--end::Nav item-->
                           
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="{{route('freightage.profileFieldOfActivity')}}">زمینه فعالیت</a>
                            </li>
                            <!--end::Nav item-->
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form id="kt_account_profile_details_form" class="form" method="POST" action={{route('freightage.profile.store')}} enctype="multipart/form-data">
                            @csrf
                            <!--begin::کارت body-->
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
                                            ...
                                            <div id="ShowImage" class="image-input-wrapper w-125px h-125px" style="background-image: url({{!empty($freightageData->photo) ? url('storage/upload/freightage_images/' . $freightageData->photo) : url('storage/upload/freightage_logo.png') }})"></div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
                                            <!--begin::نمایش existing avatar-->
                                            <div id="ShowImage" class="image-input-wrapper w-400px h-194px storeBanner" style="background-image: url({{!empty($freightageData->store_banner) ? url('storage/upload/freightage_images/' . $freightageData->store_banner) : url('storage/upload/freghtage_banner.jpg') }})"></div>
                                            <!--end::نمایش existing avatar-->
                                            <!--begin::Tags-->
                                            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="تعویض تصویر سربرگ باربری">
                                                <i class="bi bi-pencil-fill fs-7"></i>
                                                <!--begin::Inputs-->
                                 ...
                                 <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <select id="person" name="person_type" class="form-control form-control-lg form-control-solid">
                                            <option {{$freightageData->person_type == "haghighi" ? "selected" : ""}} value="haghighi">شخص حقیقی</option>
                                            <option {{$freightageData->person_type == "hoghoghi" ? "selected" : ""}} value="hoghoghi">شخص حقوقی</option>
                                        </select>
                                    </div>
                                 </div>
                                <!--end::Input group-->
                                ...
                                {{-- <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input disabled type="text" class="form-control form-control-lg form-control-solid" placeholder="نام کاربری" value="{{$freightageData->username}}" />
                                    </div>
                                    <!--end::Col-->
                                </div> --}}
                                 ...
                                 <div class="row mb-6">
                                    <!--begin::Tags-->
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">نام باربری</label>
                                    <!--end::Tags-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="shop_name" class="form-control form-control-lg form-control-solid" placeholder="نام باربری" value="{{$freightageData->shop_name}}" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="shop_address" class="form-control form-control-lg form-control-solid" placeholder="آدرس باربری" value="{{$freightageData->shop_address}}" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 fv-row">
                                                <input type="text" name="firstname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="نام" value="{{$freightageData->firstname}}" />
                                            </div>
                                            <!--end::Col-->
                                            <!--begin::Col-->
                                ...
                                <div class="row mb-6 haghighi">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            <!--begin::Col-->
                                            <div class="col-lg-12 fv-row">
                                                <input type="text" name="lastname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="نام خانوادگی" value="{{$freightageData->lastname}}" />
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Row-->
                                ...
                                <div class="row mb-6 haghighi">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="national_code" class="form-control form-control-lg form-control-solid" placeholder="کد ملی" value="{{$freightageData->national_code}}" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6 hoghoghi">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="company_number" class="form-control form-control-lg form-control-solid" placeholder="شماره شناسه شرکت" value="{{$freightageData->company_number}}" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6 hoghoghi">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="agent_name" class="form-control form-control-lg form-control-solid" placeholder="نام نماینده" value="{{$freightageData->agent_name}}" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6 haghighi">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        ...
                                        <!--begin::نمایش existing avatar-->
                                        @if($freightageData->freightage->verification_id_card)
                                            <a class="d-flex justify-content-center" href="{{route('assets', [$freightageData->role, $freightageData->id, $freightageData->freightage->verification_id_card])}}">
                                                <img style="border: 3px solid var(--kt-body-bg); box-shadow: var(--kt-box-shadow);" class="mt-5 mb-5" width="250px" src="{{route('assets', [$freightageData->role, $freightageData->id, $freightageData->freightage->verification_id_card])}}" alt="">
                                            </a>
                                        @endif
                                        <!--end::نمایش existing avatar-->
                                    </div>
                                ...
                                <div class="row mb-6 haghighi">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        ...
                                        <!--begin::نمایش existing avatar-->
                                        @if($freightageData->freightage->verification_applicant_image)
                                            <a class="d-flex justify-content-center" href="{{route('assets', [$freightageData->role, $freightageData->id, $freightageData->freightage->verification_applicant_image])}}">
                                                <img style="border: 3px solid var(--kt-body-bg); box-shadow: var(--kt-box-shadow);" class="mt-5 mb-5" width="250px" src="{{route('assets', [$freightageData->role, $freightageData->id, $freightageData->freightage->verification_applicant_image])}}" alt="">
                                            </a>
                                        @endif
                                        <!--end::نمایش existing avatar-->
                                    </div>
                                ...
                                <div class="row mb-6 hoghoghi">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        ...
                                        <!--begin::نمایش existing avatar-->
                                        @if($freightageData->freightage->verification_company_activity_license)
                                            <a class="d-flex justify-content-center" href="{{route('assets', [$freightageData->role, $freightageData->id, $freightageData->freightage->verification_company_activity_license])}}">
                                                <img style="border: 3px solid var(--kt-body-bg); box-shadow: var(--kt-box-shadow);" class="mt-5 mb-5" width="250px" src="{{route('assets', [$freightageData->role, $freightageData->id, $freightageData->freightage->verification_company_activity_license])}}" alt="">
                                            </a>
                                        @endif
                                        <!--end::نمایش existing avatar-->
                                    </div>
                                ...
                                <div class="row mb-6 hoghoghi">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        ...
                                        <!--begin::نمایش existing avatar-->
                                        @if($freightageData->freightage->verification_company_establishment_announcement)
                                            <a class="d-flex justify-content-center" href="{{route('assets', [$freightageData->role, $freightageData->id, $freightageData->freightage->verification_company_establishment_announcement])}}">
                                                <img style="border: 3px solid var(--kt-body-bg); box-shadow: var(--kt-box-shadow);" class="mt-5 mb-5" width="250px" src="{{route('assets', [$freightageData->role, $freightageData->id, $freightageData->freightage->verification_company_establishment_announcement])}}" alt="">
                                            </a>
                                        @endif
                                        <!--end::نمایش existing avatar-->
                                    </div>
                                ...
                                <div class="row mb-6 hoghoghi">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        ...
                                        <!--begin::نمایش existing avatar-->
                                        @if($freightageData->freightage->verification_company_value_added_certificate)
                                            <a class="d-flex justify-content-center" href="{{route('assets', [$freightageData->role, $freightageData->id, $freightageData->freightage->verification_company_value_added_certificate])}}">
                                                <img style="border: 3px solid var(--kt-body-bg); box-shadow: var(--kt-box-shadow);" class="mt-5 mb-5" width="250px" src="{{route('assets', [$freightageData->role, $freightageData->id, $freightageData->freightage->verification_company_value_added_certificate])}}" alt="">
                                            </a>
                                        @endif
                                        <!--end::نمایش existing avatar-->
                                    </div>
