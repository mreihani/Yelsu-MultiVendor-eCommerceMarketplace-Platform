    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <!--begin::Form-->
                <form class="form d-flex flex-column flex-lg-row" method="POST" action="{{route('update.product')}}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select name="category_id[]" class="form-select mb-2" data-control="select2" data-placeholder="انتخاب " data-allow-clear="true" multiple="multiple">
                                    ...
                                    @foreach ($selected_category_array as $item)
                                     <option value="{{$item->id}}" selected>{{$item->category_name}}</option>   
                                    @endforeach

                                    @foreach ($nonselected_category_array as $item)
                                ...
                                <!--end::Input group-->
                                <!--begin::Button-->
                                <a href="{{route('add.category')}}" class="btn btn-light-primary btn-sm mb-10">
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <!--end::Tab content-->
                        @if($products->product_verification == 'inactive' && ( $products->vendor_id != NULL || $products->merchant_id != NULL || $products->retailer_id != NULL ))
                            <div class="d-flex justify-content-end">
                                <!--begin::Button-->
                                @if($products->vendor_id != NULL)
                                    <a href="{{route('admin.vendor.product.verifyAll')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">انصراف</a>
                                @elseif($products->merchant_id != NULL)
                                    <a href="{{route('admin.merchant.product.verifyAll')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">انصراف</a>
                                @elseif($products->merchant_id != NULL)
                                    <a href="{{route('admin.retailer.product.verifyAll')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">انصراف</a>
                                @endif
                                <!--end::Button-->
                                <!--begin::Button-->
                        ...
                        @else
                            <div class="d-flex justify-content-end">
                                <!--begin::Button-->
                                <a href="{{route('all.product')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">انصراف</a>
                                <!--end::Button-->
                                <!--begin::Button-->
                                <button type="submit" id="kt_ecommerce_add_product_submit" class="btn btn-primary">
