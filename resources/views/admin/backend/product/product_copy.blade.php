    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">رونوشت محصولات</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <!--begin::Form-->
                <form class="form d-flex flex-column flex-lg-row" method="POST" action="{{route('storeCopy.product')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <input type="hidden" value="admin" id="user-role">
                                ...
                                <ul class="list-style-none mt-4">
                                    @foreach ($filter_category_array as $category)
                                        ...
                                        <div class="subCategoryBtn">
                                            @include('admin.body.layouts.admin_product.edit-categories-group', ['categories' => $category[1]])
                                        </div>
                                    @endforeach
                                </ul>   
                            </div>
