        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0"><a href="">تایید محصول تامین کننده</a></h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <td class="pe-0 text-center">
                                        ...
                                        <div class="badge badge-primary">
                                            <a class="text-white" href="{{route('vendor.details', $item->vendor->id)}}">
                                                <span class="fw-bold">{{$item->vendor->shop_name ?? 'یلسو'}}</span>
                                            </a>
                                        </div>
                                        @endif
                                    </td>
                                    ...
                                    <!--begin::نام کاربری=-->
                                    <td class="pe-0 text-center">
                                        <span class="fw-bold">{{$item->vendor->username}}</span>
                                    </td>
                                    <!--end::نام کاربری=-->
                                    <!--begin::کدینگ دسته بندی=-->
                                    <td class="pe-0 text-center">
                                    ...
                                    <td class="pe-0 text-center">
                                        <a href="mailto:{{$item->vendor->email}}">
                                            <span class="fw-bold">{{$item->vendor->email}}</span>
                                        </a>
                                    </td>
                                    <!--end::ایمیل فروشنده=-->
                                    <!--begin:: تلفن فروشنده =-->
                                    <td class="pe-0 text-center">
                                        <a href="tel:{{$item->vendor->home_phone}}">
                                            <span class="fw-bold">{{$item->vendor->home_phone}}</span>
                                        </a>
                                    </td>
                                    <!--end::تلفن فروشنده=-->
                                    <!--begin::SKU=-->
