...
@if(Route::currentRouteName() == 'admin.retailer.status')    
    <style>
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            <!--begin::جستجو-->
                            <form action="{{route('admin.retailer.status.search')}}" method="GET">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <!--end::Svg Icon-->
                                    {{-- <input type="text" name="q" data-kt-ecommerce-category-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="جستجو فروشنده" /> --}}
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-150px">نام فروشنده</th>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                @foreach ($RetailerStatus as $key => $item)
                                    <!--begin::Table row-->
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <form action="{{route('admin.retailer.statusChange')}}" method="POST">
                                                        @csrf    
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="{{route('admin.retailer.statusView', $item->id)}}" class="menu-link px-3" data-kt-ecommerce-product-filter="delete_row">نمایش اطلاعات</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </div>
                                            <!--end::Menu-->
                        ...
                        @if(Route::currentRouteName() == 'admin.retailer.status')    
                            <div class="toolbox toolbox-pagination d-flex justify-content-center mt-5">
                                {{$RetailerStatus->links('vendor.pagination.backend-dashboard')}}
                            </div>
                        @endif
