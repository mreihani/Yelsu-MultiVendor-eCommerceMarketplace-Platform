            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form id="kt_account_profile_details_form" class="form" method="POST" action="{{route('admin.vendor.about.verify.store')}}">
                            @csrf
                                ...
                                <div class="mt-10">
                                    <!--begin::or-->
                                        <textarea name="vendor_description" id="vendor_description">
                                            {{old('vendor_description') ? old('vendor_description') : $vendorData->vendor_description}}
                                        </textarea>
                                    <!--end::or-->
                                    <!--begin::توضیحات-->
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <a type="reset" class="btn btn-light btn-active-light-primary me-2" href="{{route('admin.vendor.about.verifyAll')}}">لغو</a>
