...
@if(Route::currentRouteName() == 'admin.vendor.about.verifyAll')    
    <style>
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            <!--begin::جستجو-->
                            <form action="{{route('admin.vendor.about.verifyAll.search')}}" method="GET">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($users as $key => $item)
                                        ...
                                        <tr>
                                            ...
                                            <!--begin::عملیات=-->
                                            <td class="text-end">
                                                <a class="btn btn-sm btn-primary" href="{{route('admin.vendor.about.verify',$item->id)}}" class="menu-link px-3">بررسی </a>
