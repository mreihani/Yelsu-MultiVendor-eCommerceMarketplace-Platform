...
@if(Route::currentRouteName() == 'admin.freightage.status')    
    <style>
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">مدیریت شرکت های باربری</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::آیتم-->
                        <!--begin::آیتم-->
                        <li class="breadcrumb-item text-muted">تایید شرکت های باربری</li>
                        <!--end::آیتم-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            <!--begin::جستجو-->
                            <form action="{{route('admin.freightage.status.search')}}" method="GET">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-150px">نام شرکت باربری</th>
                                    <th class="min-w-100px text-center">ایمیل شرکت باربری</th>
                                    {{-- <th class="min-w-100px">مشخصات شرکت باربری</th> --}}
                                    <th class="min-w-100px">وضعیت شرکت باربری</th>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                @foreach ($FreightageStatus as $key => $item)
                                    <!--begin::Table row-->
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <form action="{{route('admin.freightage.statusChange')}}" method="POST">
                                                        @csrf    
                                                        <input type="hidden" value="{{($item->id)}}" name="freightage_id">
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="{{route('admin.freightage.statusView', $item->id)}}" class="menu-link px-3" data-kt-ecommerce-product-filter="delete_row">نمایش اطلاعات</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </div>
                                            <!--end::Menu-->
                        ...
                        @if(Route::currentRouteName() == 'admin.freightage.status')    
                            <div class="toolbox toolbox-pagination d-flex justify-content-center mt-5">
                                {{$FreightageStatus->links('vendor.pagination.backend-dashboard')}}
                            </div>
                        @endif
