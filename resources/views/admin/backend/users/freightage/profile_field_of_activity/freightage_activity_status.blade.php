...
@if(Route::currentRouteName() == 'admin.freightage.profile.verifyAll')    
    <style>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($users as $key => $item)
                                        ...
                                        <tr>
                                            ...
                                            <!--begin::عملیات=-->
                                            <td class="text-end">
                                                <a class="btn btn-sm btn-primary" href="{{route('admin.freightage.profile.verify', $item->user->id)}}" class="menu-link px-3">بررسی </a>
