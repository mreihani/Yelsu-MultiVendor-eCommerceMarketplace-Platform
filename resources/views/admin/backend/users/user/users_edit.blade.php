                        ...
                        <form class="form" method="POST" action={{route('admin.user.update')}}>
                            ...
                            <div class="card-body border-top p-9">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 fv-row">
                                                <input type="text" name="firstname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="نام" value="{{$user->firstname}}" />
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Row-->
                                ...
                                <div class="row mb-6 mt-10">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <div class="row">
                                            <!--begin::Col-->
                                            <div class="col-lg-12 fv-row">
                                                <input type="text" name="lastname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="نام خانوادگی" value="{{$user->lastname}}" />
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Row-->
                                ...
                                <div class="row mb-6 mt-10">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <div class="row">
                                            <!--begin::Col-->
                                            <div class="col-lg-12 fv-row">
                                                <input type="text" name="username" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="نام کاربری" value="{{$user->username}}" />
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Row-->
                                ...
                                <div class="row mb-6 mt-10">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <div class="row">
                                            <!--begin::Col-->
                                            <div class="col-lg-12 fv-row">
                                                <input type="email" name="email" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="ایمیل" value="{{$user->email}}" />
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Row-->
                                ...
                                <!--end::Input group-->
                                 ...
                                 <!--begin::Input group-->
                                 <div id="specialist_category_id" class="fv-row mb-7 fv-plugins-icon-container {{$user->role == "specialist" ? "" : "d-none"}}">
                                    <!--begin::Tags-->
                                    ...
                                    <select class="form-control" name="specialist_category_id">
                                        ...
                                        @foreach ($categories as $key => $category)
                                            <option {{$user->specialist_category_id == $category->id ? 'selected' : ''}} value="{{$category->id}}">{{$category->category_name}}</option>
                                        @endforeach
                                </select>
                                    <!--end::Input-->
                                </div>
                                ...
                                <div class="mb-7 mt-10">
                                    ...
                                    <div class="d-flex fv-row">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            <!--begin::Input-->
                                            <input class="form-check-input me-3" name="role" type="radio" value="admin" id="kt_modal_update_role_option_0" {{$user->role == 'admin' ? 'checked' : ""}}>
                                            <!--end::Input-->
                                            <!--begin::Tags-->
                                    ...
                                    <div class="d-flex fv-row">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            <!--begin::Input-->
                                            <input class="form-check-input me-3" name="role" type="radio" value="editor" id="kt_modal_update_role_option_1" {{$user->role == 'editor' ? 'checked' : ""}}>
                                            <!--end::Input-->
                                            <!--begin::Tags-->
                                    ...
                                    <div class="d-flex fv-row">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            <!--begin::Input-->
                                            <input class="form-check-input me-3" name="role" type="radio" value="vendor" id="kt_modal_update_role_option_2" {{$user->role == 'vendor' ? 'checked' : ""}}>
                                            <!--end::Input-->
                                            <!--begin::Tags-->
                                    ...
                                    <div class="d-flex fv-row">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            <!--begin::Input-->
                                            <input class="form-check-input me-3" name="role" type="radio" value="specialist" id="kt_modal_update_role_option_3" {{$user->role == 'specialist' ? 'checked' : ""}}>
                                            <!--end::Input-->
                                            <!--begin::Tags-->
                                    ...
                                    <div class="d-flex fv-row">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            <!--begin::Input-->
                                            <input class="form-check-input me-3" name="role" type="radio" value="financial" id="kt_modal_update_role_option_4" {{$user->role == 'financial' ? 'checked' : ""}}>
                                            <!--end::Input-->
                                            <!--begin::Tags-->
                                    ...
                                    <div class="d-flex fv-row">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            <!--begin::Input-->
                                            <input class="form-check-input me-3" name="role" type="radio" value="merchant" id="kt_modal_update_role_option_5" {{$user->role == 'merchant' ? 'checked' : ""}}>
                                            <!--end::Input-->
                                            <!--begin::Tags-->
                                    ...
                                    <div class="d-flex fv-row">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            <!--begin::Input-->
                                            <input class="form-check-input me-3" name="role" type="radio" value="retailer" id="kt_modal_update_role_option_6" {{$user->role == 'retailer' ? 'checked' : ""}}>
                                            <!--end::Input-->
                                            <!--begin::Tags-->
                                    ...
                                    <div class="d-flex fv-row">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            <!--begin::Input-->
                                            <input class="form-check-input me-3" name="role" type="radio" value="freightage" id="kt_modal_update_role_option_7" {{$user->role == 'freightage' ? 'checked' : ""}}>
                                            <!--end::Input-->
                                            <!--begin::Tags-->
                                    ...
                                    <div class="d-flex fv-row">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            <!--begin::Input-->
                                            <input class="form-check-input me-3" name="role" type="radio" value="driver" id="kt_modal_update_role_option_8" {{$user->role == 'driver' ? 'checked' : ""}}>
                                            <!--end::Input-->
                                            <!--begin::Tags-->
                                    ...
                                    <div class="d-flex fv-row">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            <!--begin::Input-->
                                            <input class="form-check-input me-3" name="role" type="radio" value="user" id="kt_modal_update_role_option_9" {{$user->role == 'user' ? 'checked' : ""}}>
                                            <!--end::Input-->
                                            <!--begin::Tags-->
    ...
    <script>
        ...
        $(document).on("change", ".form-check-input", function (e) {
            if(e.target.value == 'specialist') {
                ...
                $('#specialist_category_id').removeClass('d-none');
            } else {
