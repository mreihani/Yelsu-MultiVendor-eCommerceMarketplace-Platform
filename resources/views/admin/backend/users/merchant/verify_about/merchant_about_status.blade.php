...
@if(Route::currentRouteName() == 'admin.merchant.about.verifyAll')    
    <style>
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::آیتم-->
                        <!--begin::آیتم-->
                        <li class="breadcrumb-item text-muted">تایید اطلاعات بازرگانان</li>
                        <!--end::آیتم-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            <!--begin::جستجو-->
                            <form action="{{route('admin.merchant.about.verifyAll.search')}}" method="GET">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <!--end::Svg Icon-->
                                    {{-- <input type="text" data-kt-ecommerce-category-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="جستجو بازرگان" /> --}}
                                    <input type="text" name="q" class="form-control form-control-solid w-250px ps-14" placeholder="جستجو بازرگان" />
                                </div>
                            </form>    
                            <!--end::جستجو-->
                        </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-250px">بازرگان</th>
                                    <th class="min-w-150px text-center">ایمیل بازرگان</th>
                                    <th class="min-w-150px text-center">تلفن بازرگان</th>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($users as $key => $item)
                                        ...
                                        <tr>
                                            ...
                                            <!--begin::عملیات=-->
                                            <td class="text-end">
                                                <a class="btn btn-sm btn-primary" href="{{route('admin.merchant.about.verify',$item->id)}}" class="menu-link px-3">بررسی </a>
