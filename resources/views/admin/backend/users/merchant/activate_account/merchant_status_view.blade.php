        ...
        <div class="card mb-5 mb-xl-10 mt-9" id="kt_profile_details_view">
            ...
            <div class="card-body p-9">
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-6">
                        <span class="fw-bold fs-6 text-gray-800">
                            <img width="125" height="125" src="{{!empty($data->photo) ? url('storage/upload/merchant_images/' . $data->photo) : url('storage/upload/no_image.jpg') }}" alt="">
                        </span>
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-6">
                        <span class="fw-bold fs-6 text-gray-800">
                            <img width="400" height="194" src="{{!empty($data->store_banner) ? url('storage/upload/merchant_images/' . $data->store_banner) : url('storage/upload/no_image_store.jpg') }}" alt="">
                        </span>
                    </div>
                    <!--end::Col-->
                </div>
