...
@if(Route::currentRouteName() == 'admin.merchant.status')    
    <style>
                        ...
                        <div class="card-title">
                            ...
                            <form action="{{route('admin.merchant.status.search')}}" method="GET">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <!--end::Svg Icon-->
                                    {{-- <input type="text" name="q" data-kt-ecommerce-category-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="جستجو بازرگان" /> --}}
                    ...
                    <div class="card-body pt-0">
                        ...
                        @if(Route::currentRouteName() == 'admin.merchant.status')    
                            <div class="toolbox toolbox-pagination d-flex justify-content-center mt-5">
                                {{$MerchantStatus->links('vendor.pagination.backend-dashboard')}}
                            </div>
                        @endif
