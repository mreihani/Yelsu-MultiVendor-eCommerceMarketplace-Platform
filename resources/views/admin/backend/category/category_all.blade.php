        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0"><a href="{{route('all.category')}}">دسته بندی ها</a></h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::آیتم-->
                        <!--begin::آیتم-->
                        <li class="breadcrumb-item text-muted">دسته بندی</li>
                        <!--end::آیتم-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            <!--begin::جستجو-->
                            <form action="{{route('all.category.search')}}" method="GET">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" name="query" class="form-control form-control-solid w-250px ps-14" placeholder="جستجو دسته بندی" />
                                </div>
                            </form>
                            <!--end::جستجو-->
                        </div>
                        ...
                        <div class="card-toolbar">
                            <!--begin::Add customer-->
                            <a href="{{route('add.category')}}" class="btn btn-primary">افزودن دسته بندی</a>
                            <!--end::Add customer-->
                        </div>
                        <!--end::کارت toolbar-->
                    </div>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="">کدینگ محصول</th>
                                    <th class="min-w-150px">نام دسته بندی اصلی</th>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($categories as $category)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!--begin::Badges-->
                                            <div class="badge badge-light-success"><a href="{{route('all.category', ['filter_id' => $category->parent])}}">{{$category->parentCategory($category->parent) ? $category->parentCategory($category->parent) : 'دسته بندی اصلی'}}</a></div>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{route('edit.category',$category->id)}}" class="menu-link px-3">ویرایش</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="{{route('delete.category',$category->id)}}" class="menu-link px-3" onclick ="return confirm('آیا برای انجام این کار اطمینان دارید؟')">حذف</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="{{route('all.category', ['filter_id' => $category->id])}}" class="menu-link px-3">نمایش زیر دسته</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </div>
                                            <!--end::Menu-->
                        ...
                        <div class="toolbox toolbox-pagination d-flex justify-content-center mt-5">
                            {{$categories->withQueryString()->links('vendor.pagination.backend-dashboard') }}
                        </div>
