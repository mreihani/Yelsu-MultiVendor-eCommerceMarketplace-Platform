    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::آیتم-->
                        <!--begin::آیتم-->
                        <li class="breadcrumb-item text-muted">ویرایش روش ارسال</li>
                        <!--end::آیتم-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl col-xl-8">
                <form method="post" action="{{route('admin.update.freightage-type')}}" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
                    @csrf
                  
                    <input type="hidden" name="id" value="{{$freightagetype->id}}">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Tags-->
                                    <!--begin::Input-->
                                    <input type="text" name="value" class="form-control mb-2" placeholder="نام روش ارسال کالا را وارد نمایید" value="{{old('value', $freightagetype->value)}}" />
                                    <!--end::Input-->
                                    <!--begin::توضیحات-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Tags-->
                                    <!--begin::Input-->
                                    <input type="text" name="description" class="form-control mb-2" placeholder="" value="{{old('description', $freightagetype->description)}}" />
                                    <!--end::Input-->
                                    <!--begin::توضیحات-->
                                ...
                                <div class="mb-10 fv-row">
                                    <!--begin::Tags-->
                                    <label class="required form-label">تعیین روش ارسال مادر </label>
                                    <!--end::Tags-->
                                    <!--begin::Input-->
                                    <select class="js-example-basic-single form-control" name="parent">
                                            <option {{$freightagetype->parent == 0 ? "selected" : ""}} value="0">روش ارسال مادر</option>
                                        @foreach ($freightage_types as $freightage_type_item)

                                            @if($freightagetype->id == $freightage_type_item->id) @continue @endif

                                            <option {{$freightagetype->parent == $freightage_type_item->id ? "selected" : ""}} value="{{$freightage_type_item->id}}">{{$freightage_type_item->value}}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Input-->
                                </div>
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <select class="js-example-basic-single form-control" name="freightagetype_title">
                                        <option {{$freightagetype->freightagetype_title == "road" ? "selected" : ""}} value="road">زمینی</option>
