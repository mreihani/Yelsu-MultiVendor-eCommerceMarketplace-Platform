    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl col-xl-8">
                <form method="post" action="{{route('admin.store.freightage-param')}}" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Tags-->
                                    <!--begin::Input-->
                                    <input type="text" name="title" class="form-control mb-2" placeholder="عنوان ضریب حمل کالا را وارد نمایید" value="{{old('title')}}" />
                                    <!--end::Input-->
                                    <!--begin::توضیحات-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Tags-->
                                    <!--begin::Input-->
                                    <input type="text" name="keyword" class="form-control mb-2" placeholder="کلمه کلیدی ضریب حمل کالا را وارد نمایید" value="{{old('keyword')}}" />
                                    <!--end::Input-->
                                    <!--begin::توضیحات-->
