    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">ویرایش مقاله</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::آیتم-->
                        <!--begin::آیتم-->
                        <li class="breadcrumb-item text-muted">ویرایش مقاله</li>
                        <!--end::آیتم-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <!--begin::Form-->
                <form class="form d-flex flex-column flex-lg-row" method="POST" action="{{route('update.blog.post')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <style>.image-input-placeholder { background-image: url({{!empty($blogpost->post_image) ? url($blogpost->post_image) : url(asset('storage/upload/no_image_product.jpg'))}}); } [data-theme="dark"] .image-input-placeholder { background-image: url({{!empty($blogpost->post_image) ? url($blogpost->post_image) : url(asset('storage/upload/no_image_product.jpg'))}}); }</style>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    <div class="rounded-circle {{$blogpost->status == 'active' ? "bg-success" : "bg-warning"}} w-15px h-15px" id="kt_ecommerce_add_status"></div>
                                </div>
                                <!--begin::کارت toolbar-->
                            </div>
                            <!--end::کارت header-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select class="form-select mb-2" data-control="select2" name="status" data-hide-search="true" data-placeholder="انتخاب" id="kt_ecommerce_add_status_select">
                                    <option></option>
                                    <option value="active" {{$blogpost->status == 'active' ? "selected" : ""}}>منتشر شده</option>
                                    <option value="disabled" {{$blogpost->status == 'disabled' ? "selected" : ""}}>در حال بازبینی</option>
                                </select>
                                <!--end::انتخاب2-->
                                <!--begin::توضیحات-->
                                    ...
                                    <!--begin::انتخاب2-->
                                        <select class="js-example-basic-single form-control" name="category_id">
                                            @foreach ($blogcategories as $blogcategory)
                                                <option value="{{$blogcategory->id}}" {{$blogcategory->id == $blogpost->category_id ? "selected" : ""}}>{{$blogcategory->blog_category_name}}</option>
                                            @endforeach
                                        </select>
                                    <!--end::انتخاب2-->
                                <!--begin::توضیحات-->
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::Input-->
                                                <input type="text" name="post_title" class="form-control mb-2" placeholder="عنوان مقاله" value="{{old('post_title') ? old('post_title') : $blogpost->post_title}}"/>
                                                <!--end::Input-->
                                                <!--begin::توضیحات-->
                                            ...
                                            <!--begin::Input group-->
                                             <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::Input-->
                                                <input type="text" name="post_slug" class="form-control mb-2" placeholder="اسلاگ URL" value="{{old('post_slug') ? old('post_slug') : $blogpost->post_slug}}"/>
                                                <!--end::Input-->
                                                <!--begin::توضیحات-->
                                            ...
                                            <div>
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::or-->
                                                <textarea name="post_short_description" id="post_short_description">{{old('post_short_description') ? old('post_short_description') : $blogpost->post_short_description}}</textarea>
                                                <!--end::or-->
                                                <!--begin::توضیحات-->
                                            ...
                                            <div class="mt-10">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::or-->
                                                    <textarea name="post_long_description" id="post_long_description">{{old('post_long_description') ? old('post_long_description') : $blogpost->post_long_description}}</textarea>
                                                <!--end::or-->
                                                <!--begin::توضیحات-->
                                                <div class="text-muted fs-7">برای دید بهتر، توضیحاتی را برای مقاله تنظیم کنید.</div>
                                                <!--end::توضیحات-->
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control mb-2" name="meta_title" placeholder="نام متا تگ" value="{{old('meta_title') ? old('meta_title') : $blogpost->meta_title}}"/>
                                                <!--end::Input-->
                                                <!--begin::توضیحات-->
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::or-->
                                                    <textarea class="form-control mb-2" name="meta_description" placeholder="توضیحات متا">{{old('meta_description') ? old('meta_description') : $blogpost->meta_description}}</textarea>
                                                <!--end::or-->
                                                <!--begin::توضیحات-->
                                            ...
                                            <div>
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::or-->
                                                <input id="kt_ecommerce_add_product_meta_keywords" name="meta_keywords" class="form-control mb-2" placeholder="انواع میلگرد، نحوه تولید سیمان، تیرآهن لانه زنبوری" value="{{old('meta_keywords') ? old('meta_keywords') : $blogpost->meta_keywords}}"/>
                                                <!--end::or-->
                                                <!--begin::توضیحات-->
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{route('admin.blog.post')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">انصراف</a>
                            <!--end::Button-->
                            <!--begin::Button-->
