	...
	<body id="kt_body" class="app-blank app-blank">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
					...
					<div class="d-flex flex-center flex-column flex-lg-row-fluid">
						...
						<div class="w-lg-500px p-10">
							<!--begin::Form-->
							<form method="POST" action="{{route('profile.2fa.phone')}}" class="form w-100 mb-13">
                                @csrf
								<!--begin::Icon-->
							...
							<div class="text-center fw-semibold fs-5">
								...
								<a href="{{route('profile.2fa.phoneResend')}}" class="link-primary fs-5 me-1 resendlinkbtn">ارسال دوباره</a>
				...
				<!--end::Body-->
				<!--begin::کناری-->
				<div class="d-flex flex-lg-row-fluid w-lg-50 bgi-position-center bgi-size-cover order-1 order-lg-2" style="background-image: url({{asset('adminbackend/assets/media/misc/auth-bg.jpg')}}); background-repeat:no-repeat;">
					<!--begin::Content-->
