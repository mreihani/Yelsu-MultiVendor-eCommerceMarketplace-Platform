                        ...
                        <div class="flex-col">
                            <div class="widget" >
                                <ul class="widget-body text-center">
                                    <li><b>آدرس دفتر مرکزی:</b> تهران، خیابان دکتر شریعتی، خیابان وحید دستگردی، پلاک 112، واحد 9</li>
                                    <li><b>کدپستی:</b> 1919944985</li>
                                    <li><b>تلفن دفتر مرکزی:</b><a href="tel:02122902471"> 2-02122902471</a></li>
                        ...
                        <div class="flex-col">
                            <div class="widget text-center">
                                <div class="container text-center">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="{{asset('frontend/assets/images/anjoman_senfi_membership.jpg')}}" data-lightbox="image-2" data-title="انجمن صنفی کارفرمایی فروشگاه های اینترنتی تهران">
