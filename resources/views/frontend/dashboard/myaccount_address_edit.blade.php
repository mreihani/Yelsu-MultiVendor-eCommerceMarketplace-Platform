        ...
        <div class="container">
            ...
            <div class="row mb-5">
                <form method="POST" action="{{route('dashboard.address.update')}}">
                    @csrf
                    <input type="hidden" name="id" value="{{$useroutlet->id}}">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="row">
                                <div class="col-lg-5 fv-row">
                                    <input placeholder="طول جغرافیایی / longitude" type="text" class="form-control form-control-lg form-control-solid" id="longitude" name="longitude" value="{{$useroutlet->longitude}}">      
                                </div>
                                <div class="col-lg-5 fv-row">
                                    <input placeholder="عرض جغرافیایی / latitude" type="text" class="form-control form-control-lg form-control-solid" id="latitude" name="latitude" value="{{$useroutlet->longitude}}">      
                                </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="به عنوان مثال: منزل"
                                        class="form-control form-control-md mb-2" name="name" value="{{old('name',$useroutlet->name)}}">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="به عنوان مثال: ایران"
                                        class="form-control form-control-md mb-2" id="country" name="country" value="{{old('country',$useroutlet->country)}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row gutter-sm">                           
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="به عنوان مثال: تهران"
                                        class="form-control form-control-md mb-2" id="province" name="province" value="{{old('province',$useroutlet->province)}}">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <label>شهر *</label>
                                    <input type="text" placeholder="به عنوان مثال: تهران"
                                        class="form-control form-control-md mb-2" id="city" name="city" value="{{old('city',$useroutlet->city)}}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="نام خیابان یا کوچه و پلاک"
                                        class="form-control form-control-md mb-2" id="address" name="address" value="{{old('address',$useroutlet->address)}}">
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <label>کد پستی (اختیاری)</label>
                                    <input type="number" class="form-control form-control-md" name="postalcode" value="{{old('postalcode',$useroutlet->postalcode)}}">
                                </div>
                            </div>
                        </div>
