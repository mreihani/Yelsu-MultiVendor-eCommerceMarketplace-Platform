            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="card-body pt-9 pb-0">
                        ...
                        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                            ...
                            <div class="me-7 mb-4">
                                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                    <img src="{{!empty($editorData->photo) ? url('storage/upload/editor_images/' . $editorData->photo) : url('storage/upload/no_image.jpg') }}" alt="image" />
                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        {{-- <div class="d-flex align-items-center mb-2">
                                            <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{$editorData->firstname . " " . $editorData->lastname}}</a>
                                            <a href="#">
                                        ...
                                        <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                            ...
                                            <!--end::Svg Icon-->{{$editorData->email}}</a> --}}
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::user-->
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="{{route('editor.profile')}}">پروفایل من</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="{{route('editor.profileSettings')}}">تنظیمات حساب کاربری</a>
                            </li>
                            <!--end::Nav item-->
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form class="form" method="POST" action={{route('editor.profile.store')}} enctype="multipart/form-data">
                            @csrf
                            <!--begin::کارت body-->
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
                                            ...
                                            <div id="ShowImage" class="image-input-wrapper w-125px h-125px" style="background-image: url({{!empty($editorData->photo) ? url('storage/upload/editor_images/' . $editorData->photo) : url('storage/upload/no_image.jpg') }})"></div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input disabled type="text" class="form-control form-control-lg form-control-solid" placeholder="نام کاربری" value="{{$editorData->username}}" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--begin::Input group-->
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 fv-row">
                                                <input type="text" name="firstname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="نام" value="{{$editorData->firstname}}" />
                                            </div>
                                            <!--end::Col-->
                                            <!--begin::Col-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            <!--begin::Col-->
                                            <div class="col-lg-12 fv-row">
                                                <input type="text" name="lastname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="نام خانوادگی" value="{{$editorData->lastname}}" />
                                            </div>
                                            <!--end::Col-->
                                            <!--begin::Col-->
                ...
                {{-- <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_signin_password_edit" class="flex-row-fluid m-10">
                        <!--begin::Form-->
                        <form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="{{route('editor.update.password')}}">
                            @csrf
                            <div class="row mb-1">
                                <div class="col-lg-4">
