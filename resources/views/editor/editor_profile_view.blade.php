    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card-body pt-9 pb-0">
                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                {{-- <div class="d-flex align-items-center mb-2">
                                    <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{$editorData->name}}</a>
                                    <a href="#">
                                ...
                                <div class="me-0">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3 my-1">
                                            <a href="{{route('editor.profileSettings')}}" class="menu-link px-3">تنظیمات</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu 3-->
                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                    ...
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="{{route('editor.profile')}}">پروفایل من</a>
                    </li>
                    <!--end::Nav item-->
                    <!--begin::Nav item-->
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5" href="{{route('editor.profileSettings')}}">تنظیمات حساب کاربری</a>
                    </li>
                    <!--end::Nav item-->
                    <!--begin::Nav item-->
        ...
        <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
            ...
            <div class="card-header cursor-pointer">
                ...
                <!--end::کارت title-->
                <!--begin::Actions-->
                <a href="{{route('editor.profileSettings')}}" class="btn btn-sm btn-primary align-self-center">ویرایش اطلاعات</a>
                <!--end::Actions-->
            </div>
            <!--begin::کارت header-->
            <!--begin::کارت body-->
            <div class="card-body p-9">
                ...
                <div class="row mb-7">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-800">{{$editorData->firstname . " " . $editorData->lastname}}</span>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Row-->
                ...
                <div class="row mb-7">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        <a href="#" class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{$editorData->username}}</a>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-8 fv-row">
                        <span class="fw-semibold text-gray-800 fs-6">{{$editorData->email}}</span>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-8 d-flex align-items-center">
                        @if($editorData->home_phone && $editorData->phone_verified)
                            <span class="fw-bold fs-6 text-gray-800 me-2">{{$editorData->home_phone}}</span><span class="badge badge-success">تایید شده</span>
                        @else
