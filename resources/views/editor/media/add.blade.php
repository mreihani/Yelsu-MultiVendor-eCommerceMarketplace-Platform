    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <form method="post" action="{{route('editor.media.store')}}" class="form d-flex flex-column flex-lg-row justify-content-center" enctype="multipart/form-data">
                    @csrf
                    <!--begin::کناری column-->
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-500px mb-7 me-lg-10">
                        ...
                        <div class="d-flex justify-content-center">
                            <!--begin::Button-->
                            <a href="{{route('editor.media.files')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">انصراف</a>
                            <!--end::Button-->
                            <!--begin::Button-->
