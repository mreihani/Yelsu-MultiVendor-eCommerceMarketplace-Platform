    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">ویرایش محصولات</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <!--begin::Form-->
                <form class="form d-flex flex-column flex-lg-row" method="POST" action="{{route('specialist.update.product')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select name="category_id[]" class="form-select mb-2" data-control="select2" data-placeholder="انتخاب " data-allow-clear="true" multiple="multiple">
                                    ...
                                    @foreach ($categories as $item)
                                     <option value="{{$item->id}}" {{in_array($item->id, $products->categories->pluck('id')->toArray()) ? "selected" : ""}}>{{$item->category_name}}</option>   
                                    @endforeach
                                </select>
                                <!--end::انتخاب2-->
                                <!--begin::توضیحات-->
                                ...
                                <!--end::Input group-->
                                <!--begin::Button-->
                                <a href="{{route('specialist.add.category')}}" class="btn btn-light-primary btn-sm mb-10">
                                ...
                                {{-- <div>
                                <label class="form-label">فروشندگان</label>
                                <select name="vendor_id[]" class="form-select mb-2" data-control="select2" data-placeholder="انتخاب " data-allow-clear="true" multiple="multiple">
                                    <option></option>
                                  
                                    @foreach ($selected_vendor_array as $item)
                                      <option value="{{$item->id}}" selected>{{$item->firstname . " " . $item->lastname}}</option>   
                                    @endforeach

                                    @foreach ($nonselected_vendor_array as $item)
                        ...
                        @foreach ($allAttributes as $attribute)
                            @if(in_array($role, explode(',', $attribute->role)) && in_array($specialistData->specialist_category_id, App\Models\Category::findRootCategoryArray(explode(",", $attribute->category_id))->pluck('id')->toArray()) && ($vendor_sector != NULL ? App\Models\User::canVendorSeeAttribute($attribute->category_id, $vendor_sector) : true))
                                <div class="card card-flush py-4">
                                    <!--begin::کارت header-->
                                    <div class="card-header">
                                        <!--begin::کارت title-->
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::Input-->
                                                <input type="text" name="product_name" class="form-control mb-2" placeholder="نام محصول" value="{{old('product_name') ? old('product_name') : $products->product_name}}"/>
                                                <!--end::Input-->
                                                <!--begin::توضیحات-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::Input-->
                                                <input type="text" name="product_slug" class="form-control mb-2" placeholder="اسلاگ URL" value="{{old('product_slug') ? old('product_slug') : $products->product_slug}}"/>
                                                <!--end::Input-->
                                                <!--begin::توضیحات-->
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::or-->
                                                <textarea name="short_desc" id="short_desc">{{old('short_desc') ? old('short_desc') : $products->short_desc}}</textarea>
                                                <!--end::or-->
                                                <!--begin::توضیحات-->
                                            ...
                                            <div class="mt-10">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::or-->
                                                <textarea name="long_desc" id="long_desc">{{old('long_desc') ? old('long_desc') : $products->long_desc}}</textarea>
                                                <!--end::or-->
                                                <!--begin::توضیحات-->
                                                <div class="text-muted fs-7">برای دید بهتر، توضیحاتی را برای محصول تنظیم کنید.</div>
                                                <!--end::توضیحات-->
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::Input-->
                                                <input type="text" name="selling_price" class="form-control mb-2" placeholder="قیمت محصول" value="{{old('selling_price') ? old('selling_price') : $products->selling_price}}" />
                                                <!--end::Input-->
                                                <!--begin::توضیحات-->
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::Input-->
                                                <input type="text" name="product_code" class="form-control mb-2" placeholder="کد محصول را وارد کنید" value="{{old('product_code') ? old('product_code') : $products->product_code}}" />
                                                <!--end::Input-->
                                                <!--begin::توضیحات-->
                        ...
                        @if($products->product_verification == 'inactive' && ( $products->vendor_id != NULL || $products->retailer_id != NULL ))
                            <div class="d-flex justify-content-end">
                                <!--begin::Button-->
                                @if($products->vendor_id != NULL)
                                    <a href="{{route('specialist.vendor.product.verifyAll')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">انصراف</a>
                                @elseif($products->retailer_id != NULL)
                                    <a href="{{route('specialist.retailer.product.verifyAll')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">انصراف</a>
                                @endif
                                <!--end::Button-->
                                <!--begin::Button-->
                                <button type="submit" id="kt_ecommerce_add_product_submit" class="btn btn-primary">
                                    <span class="indicator-label">تایید و انتشار</span>
                        ...
                        @else
                            <div class="d-flex justify-content-end">
                                <!--begin::Button-->
                                <a href="{{route('specialist.all.product')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">انصراف</a>
                                <!--end::Button-->
                                <!--begin::Button-->
                                <button type="submit" id="kt_ecommerce_add_product_submit" class="btn btn-primary">
