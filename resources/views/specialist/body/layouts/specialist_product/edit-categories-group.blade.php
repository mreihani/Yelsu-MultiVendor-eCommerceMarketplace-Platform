@foreach ($categories as $key => $category)
    ...
    @if($vendor_sector != NULL ? in_array($category->id, explode(",", $vendor_sector)) : true)
        ...
        <div class="mb-1 subCatGroup" style="margin-right: 30px;">
            @include('specialist.body.layouts.specialist_product.edit-categories-group', ['categories' => $category->child])  
        </div>
