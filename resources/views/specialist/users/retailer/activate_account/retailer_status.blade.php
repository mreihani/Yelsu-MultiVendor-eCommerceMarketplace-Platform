                ...
                <div class="card card-flush">
                        ...
                        <div class="card-title">
                            ...
                            <form action="{{route('specialist.retailer.status.search')}}" method="GET">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" name="query" class="form-control form-control-solid w-250px ps-14" placeholder="جستجو فروشنده" />
                                </div>
                            </form>        
                            <!--end::جستجو-->
                        </div>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="toolbox toolbox-pagination d-flex justify-content-center mt-5">
                            {{$relatedRetailers->withQueryString()->links('vendor.pagination.backend-dashboard') }}
                        </div>
