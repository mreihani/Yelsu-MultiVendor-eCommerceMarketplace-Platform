...
@if(Route::currentRouteName() == 'specialist.retailer.about.verifyAll')    
    <style>
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::آیتم-->
                        <!--begin::آیتم-->
                        <li class="breadcrumb-item text-muted">تایید اطلاعات فروشندگان</li>
                        <!--end::آیتم-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            <!--begin::جستجو-->
                            <form action="{{route('specialist.retailer.about.verifyAll.search')}}" method="GET">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-250px">فروشنده</th>
                                    <th class="min-w-150px text-center">ایمیل فروشنده</th>
                                    <th class="min-w-150px text-center">تلفن فروشنده</th>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($relatedRetailers as $key => $item)
                                    ...
                                    <tr>
                                        ...
                                        <!--begin::عملیات=-->
                                        <td class="text-end">
                                            <a class="btn btn-sm btn-primary" href="{{route('specialist.retailer.about.verify',$item->id)}}" class="menu-link px-3">بررسی </a>
