                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            <!--begin::جستجو-->
                            <form action="{{route('specialist.freightage.status.search')}}" method="GET">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-150px">باربری</th>
                                    <th class="min-w-100px text-center">ایمیل باربری</th>
                                    {{-- <th class="min-w-100px">مشخصات باربری</th> --}}
                                    <th class="min-w-100px">وضعیت باربری</th>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <form action="{{route('specialist.freightage.statusChange')}}" method="POST">
                                                        @csrf    
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="{{route('specialist.freightage.statusView', $item->id)}}" class="menu-link px-3" data-kt-ecommerce-product-filter="delete_row">نمایش اطلاعات</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </div>
                                            <!--end::Menu-->
