...
@if(Route::currentRouteName() == 'specialist.freightage.profile.verifyAll')    
    <style>
...
<div class="d-flex flex-column flex-column-fluid">
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            <!--begin::جستجو-->
                            <form action="{{route('specialist.freightage.profile.verifyAll.search')}}" method="GET">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($relatedFreightages as $key => $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <!--begin::Thumbnail-->
                                                    <a href="{{route('freightage.details', $item->user->id)}}" class="symbol symbol-50px">
                                                        <span class="symbol-label" style="background-image:url({{!empty($item->user->photo) ? asset('storage/upload/freightage_images/' . $item->user->photo) : url(asset('storage/upload/no_image.jpg'))}});"></span>
                                                    </a>
                                                    <!--end::Thumbnail-->
                                                    <div class="ms-5">
                                                        <!--begin::Title-->
                                                        <a href="{{route('freightage.details',$item->user->id)}}" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-item-filter="item_name">{{$item->user->shop_name}}</a>
                                                        <!--end::Title-->
                                                        <!--begin::توضیحات-->
                                            ...
                                            <!--begin::عملیات=-->
                                            <td class="text-end">
                                                <a class="btn btn-sm btn-primary" href="{{route('specialist.freightage.profile.verify', $item->user->id)}}" class="menu-link px-3">بررسی </a>
    ...
    <script src="{{asset('specialistbackend/assets/js/custom/apps/ecommerce/catalog/categories.js')}}"></script>
    {{-- <script src="{{asset('specialistbackend/assets/js/widgets.bundle.js')}}"></script>
    <script src="{{asset('specialistbackend/assets/js/custom/widgets.js')}}"></script>
    <script src="{{asset('specialistbackend/assets/js/custom/apps/chat/chat.js')}}"></script>
    <script src="{{asset('specialistbackend/assets/js/custom/utilities/modals/upgrade-plan.js')}}"></script>
    <script src="{{asset('specialistbackend/assets/js/custom/utilities/modals/create-app.js')}}"></script> --}}
    <script src="{{asset('specialistbackend/assets/js/custom/utilities/modals/users-search.j')}}s"></script>
