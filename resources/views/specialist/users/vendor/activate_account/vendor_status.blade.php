...
@if(Route::currentRouteName() == 'specialist.vendor.vendor.status')    
    <style>
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">مدیریت فروشندگان</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::آیتم-->
                        <!--begin::آیتم-->
                        <li class="breadcrumb-item text-muted">تایید فروشندگان</li>
                        <!--end::آیتم-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            <!--begin::جستجو-->
                            <form action="{{route('specialist.vendor.status.search')}}" method="GET">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <!--end::Svg Icon-->
                                    {{-- <input type="text" data-kt-ecommerce-category-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="جستجو تأمین کننده" /> --}}
                                    <input type="text" name="q" class="form-control form-control-solid w-250px ps-14" placeholder="جستجو تأمین کننده" />
                                </div>
                            </form>        
                            <!--end::جستجو-->
                        </div>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-150px">تأمین کننده</th>
                                    <th class="min-w-100px text-center">ایمیل تأمین کننده</th>
                                    {{-- <th class="min-w-100px">مشخصات تأمین کننده</th> --}}
                                    <th class="min-w-100px">وضعیت تأمین کننده</th>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($relatedVendors as $key => $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <!--begin::Thumbnail-->
                                                <a href="{{route('vendor.details',$item->id)}}" class="symbol symbol-50px">
                                                    <span class="symbol-label" style="background-image:url({{!empty($item->photo) ? asset('storage/upload/vendor_images/' . $item->photo) : url(asset('storage/upload/no_image.jpg'))}});"></span>
                                                </a>
                                                <!--end::Thumbnail-->
                                                <div class="ms-5">
                                                    <!--begin::Title-->
                                                    <a href="{{route('vendor.details',$item->id)}}" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-item-filter="item_name">{{$item->shop_name}}</a>
                                                    <!--end::Title-->
                                                    <!--begin::توضیحات-->
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <form action="{{route('specialist.vendor.statusChange')}}" method="POST">
                                                        @csrf    
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="{{route('specialist.vendor.statusView', $item->id)}}" class="menu-link px-3" data-kt-ecommerce-product-filter="delete_row">نمایش اطلاعات</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </div>
                                            <!--end::Menu-->
                        ...
                        @if(Route::currentRouteName() == 'specialist.vendor.status')    
                            <div class="toolbox toolbox-pagination d-flex justify-content-center mt-5">
                                {{$relatedVendors->links('vendor.pagination.backend-dashboard')}}
                            </div>
                        @endif
