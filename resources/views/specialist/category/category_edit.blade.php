    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::آیتم-->
                        <!--begin::آیتم-->
                        <li class="breadcrumb-item text-muted">ویرایش دسته بندی</li>
                        <!--end::آیتم-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <form method="post" action="{{route('specialist.update.category')}}" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <style>.image-input-placeholder { background-image: url({{!empty($category->category_image) ? url($category->category_image) : url(asset('storage/upload/no_image_product.jpg'))}}); } [data-theme="dark"] .image-input-placeholder { background-image: url('assets/media/svg/files/blank-image-dark.svg'); }</style>
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Tags-->
                                        <!--begin::Input-->
                                        <input type="text" name="category_name" class="form-control mb-2" placeholder="نام دسته بندی محصول" value="{{old('category_name') ? old('category_name') : $category->category_name}}" />
                                        <!--end::Input-->
                                        <!--begin::توضیحات-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        <!--begin::Tags-->
                                        <label class="form-label">توضیحات دسته بندی</label>
                                        <!--end::Tags-->
                                        <!--begin::Input-->
                                        <textarea name="category_description" id="category_description">{{old('category_description') ? old('category_description') : $category->category_description}}</textarea>
                                        <!--end::Input-->
                                        <!--begin::توضیحات-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <select class="js-example-basic-single form-control" name="parent">
                                            ...
                                            @foreach ($nonselected_category_array as $key => $category_item)
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10">
                                    ...
                                    <!--end::Tags-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control mb-2" name="meta_title" placeholder="نام متا تگ" value="{{old('meta_title', $category->meta_title)}}"/>
                                    <!--end::Input-->
                                    <!--begin::توضیحات-->
                                ...
                                <div class="mb-10">
                                    ...
                                    <!--end::Tags-->
                                    <!--begin::or-->
                                        <textarea class="form-control mb-2" name="meta_description" placeholder="توضیحات متا">{{old('meta_description', $category->meta_description)}}</textarea>
                                    <!--end::or-->
                                    <!--begin::توضیحات-->
                                ...
                                <div>
                                    ...
                                    <!--end::Tags-->
                                    <!--begin::or-->
                                    <input id="kt_ecommerce_add_product_meta_keywords" name="meta_keywords" class="form-control mb-2" placeholder="قیمت میلگرد، قیمت سیمان، قیمت تیرآهن" value="{{old('meta_keywords', $category->meta_keywords)}}"/>
                                    <!--end::or-->
                                    <!--begin::توضیحات-->
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{route('specialist.all.category')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">انصراف</a>
                            <!--end::Button-->
                            <!--begin::Button-->
