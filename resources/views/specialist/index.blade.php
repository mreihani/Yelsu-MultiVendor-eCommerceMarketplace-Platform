            ...
            <div class="card card-flush h-md-100 mt-10">
                ...
                <div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0" style="background-position: 100% 50%; background-image:url('{{asset('adminbackend/assets/media/stock/900x600/42.png')}}')">
                    ...
                    <div class="mb-10">
                        ...
                        <span class="me-2">به پیشخوان کارشناس خوش آمدید 
                    </div>
                        <!--end::Title-->
                    ...
                    <!--begin::Wrapper-->
                    <!--begin::Illustration-->
                    <img class="mx-auto h-600px theme-light-show" src="{{asset('adminbackend/assets/media/illustrations/dozzy-1/19.png')}}" alt="" />
                    <img class="mx-auto h-600px theme-dark-show" src="{{asset('adminbackend/assets/media/illustrations/dozzy-1/19.png')}}" alt="" />
                    <!--end::Illustration-->
                </div>
                <!--end::Body-->
            </div>
