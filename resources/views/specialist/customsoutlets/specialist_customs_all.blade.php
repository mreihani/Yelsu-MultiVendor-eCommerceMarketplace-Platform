                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar">
                            ...
                            @if($customsURL == "type=customs")
                                <a href="{{route('specialist.create.customsoutlet', $customsURL)}}" class="btn btn-primary">افزودن آدرس گمرک</a>
                            @elseif($customsURL == "type=port")
                                <a href="{{route('specialist.create.customsoutlet', $customsURL)}}" class="btn btn-primary">افزودن آدرس بندر</a>
                            @elseif($customsURL == "type=free_zone")
                                <a href="{{route('specialist.create.customsoutlet', $customsURL)}}" class="btn btn-primary">افزودن آدرس منطقه آزاد</a>
                            @elseif($customsURL == "type=special_zone")
                                <a href="{{route('specialist.create.customsoutlet', $customsURL)}}" class="btn btn-primary">افزودن آدرس منطقه ویژه اقتصادی</a>
                            @else
                                <a href="{{route('specialist.create.customsoutlet', $customsURL)}}" class="btn btn-primary">افزودن آدرس</a>
                            @endif
                            <!--end::Add customer-->
                        </div>
                        <!--end::کارت toolbar-->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if($outlet->customs_type == "customs")
                                                    <a href="{{route('specialist.all.customsoutlet', ['type' => "customs"])}}">
                                                        <div class="badge badge-info">
                                                            گمرک
                                                        </div>
                                                    </a>
                                                @elseif($outlet->customs_type == "port")
                                                    <a href="{{route('specialist.all.customsoutlet', ['type' => "port"])}}">
                                                        <div class="badge badge-primary">
                                                            بندر
                                                        </div>
                                                    </a>
                                                @elseif($outlet->customs_type == "free_zone")
                                                    <a href="{{route('specialist.all.customsoutlet', ['type' => "free_zone"])}}">
                                                        <div class="badge badge-success">
                                                            منطقه آزاد
                                                        </div>
                                                    </a>
                                                @elseif($outlet->customs_type == "special_zone")
                                                    <a href="{{route('specialist.all.customsoutlet', ['type' => "special_zone"])}}">
                                                        <div class="badge badge-success">
                                                            منطقه ویژه اقتصادی
                                                        </div>
                                                    </a>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('specialist.edit.customsoutlet', $outlet->id)}}" class="menu-link px-3">ویرایش</a>
                                                    </div>
                                                    <!--end::Menu item-->

                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('specialist.delete.customsoutlet', $outlet->id)}}" class="menu-link px-3" onclick ="return confirm('آیا برای انجام این کار اطمینان دارید؟')">حذف</a>
                                                    </div>
                                                    <!--end::Menu item-->
