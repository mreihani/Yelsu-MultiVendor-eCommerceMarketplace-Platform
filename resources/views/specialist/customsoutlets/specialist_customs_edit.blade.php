...
<script>
    let latitudeVal = {!! json_encode($outlet->latitude) !!};
    let longitudeVal = {!! json_encode($outlet->longitude) !!};
</script>
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    {{-- <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expوed="true" aria-controls="kt_account_profile_details">
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bold m-0">اطلاعات و آدرس انبار / کارگاه / کارخانه / دپوی کالا</h3>
                        </div>
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show outlet-page">
                        <!--begin::Form-->
                        <form id="kt_account_profile_details_form" class="form" method="POST" action={{route('specialist.update.customsoutlet')}} enctype="multipart/form-data">
                            @csrf
                            <!--begin::کارت body-->
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5 fv-row">
                                            <input placeholder="طول جغرافیایی / longitude" type="text" class="form-control form-control-lg form-control-solid" id="longitude" name="longitude" value="{{$outlet->longitude}}">      
                                        </div>
                                        <div class="col-lg-5 fv-row">
                                            <input placeholder="عرض جغرافیایی / latitude" type="text" class="form-control form-control-lg form-control-solid" id="latitude" name="latitude" value="{{$outlet->latitude}}">      
                                        </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 text-center">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
                                            ...
                                            <div id="ShowImage" class="image-input-wrapper w-125px h-125px" style="background-image: url({{!empty($outlet->photo) ? url($outlet->photo) : url('storage/upload/customs_default.png') }})"></div>
                                            {{-- <input type="hidden" name="old_photo" value="{{$outlet->photo}}"> --}}
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 text-center">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
                                            <!--begin::نمایش existing avatar-->
                                            <div id="ShowImage" class="image-input-wrapper w-400px h-194px storeBanner" style="background-image: url({{!empty($outlet->banner_photo) ? url($outlet->banner_photo) : url('storage/upload/customs_default_banner.jpg') }})"></div>
                                            {{-- <input type="hidden" name="old_banner_photo" value="{{$outlet->banner_photo}}"> --}}
                                            <!--end::نمایش existing avatar-->
                                            <!--begin::Tags-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <select id="customs_type" name="customs_type" class="form-control form-control-lg form-control-solid form-select">
                                            <option {{$outlet->customs_type == "customs" ? 'selected' : '' }} value="customs">گمرک</option>
                                            <option {{$outlet->customs_type == "port" ? 'selected' : '' }} value="port">بندر</option>
                                            <option {{$outlet->customs_type == "free_zone" ? 'selected' : '' }} value="free_zone">منطقه آزاد</option>
                                            <option {{$outlet->customs_type == "special_zone" ? 'selected' : '' }} value="special_zone">منطقه ویژه اقتصادی</option>
                                        </select>
                                    </div>
                                 </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="name" class="form-control form-control-lg form-control-solid" placeholder="نام محل مورد نظر را وارد نمایید" value="{{old('name') ? old('name') : $outlet->name }}" />
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" id="country" name="country" class="form-control form-control-lg form-control-solid" placeholder="کشور محل مورد نظر را وارد نمایید" value="{{old('country') ? old('country') : $outlet->country }}" />
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" id="province" name="province" class="form-control form-control-lg form-control-solid" placeholder="استان محل مورد نظر را وارد نمایید" value="{{old('province') ? old('province') : $outlet->province }}" />
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="address" id="address" class="form-control form-control-lg form-control-solid" placeholder="آدرس محل مورد نظر را وارد نمایید" value="{{old('address') ? old('address') : $outlet->address }}" />
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="number" name="postalcode" class="form-control form-control-lg form-control-solid" placeholder="کد پستی محل مورد نظر را وارد نمایید" value="{{old('postalcode') ? old('postalcode') : $outlet->postalcode }}" />
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="number" name="phone" class="form-control form-control-lg form-control-solid" placeholder="شماره تلفن محل مورد نظر را وارد نمایید" value="{{old('phone') ? old('phone') : $outlet->phone }}" />
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="number" name="fax" class="form-control form-control-lg form-control-solid" placeholder="شماره فکس محل مورد نظر را وارد نمایید" value="{{old('fax') ? old('fax') : $outlet->fax }}" />
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <textarea name="about_customs" id="about_customs">
                                            {{old('about_customs') ? old('about_customs') : $outlet->about_customs}}
                                        </textarea>
                                    </div>
                                    <!--end::Col-->         
                                </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <textarea name="customs_specs" id="customs_specs">
                                            {{old('customs_specs') ? old('customs_specs') : $outlet->customs_specs}}
                                        </textarea>
                                    </div>
                                    <!--end::Col-->         
                                </div>
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <a type="reset" class="btn btn-light btn-active-light-primary me-2" href="{{route('specialist.all.customsoutlet')}}">لغو</a>
